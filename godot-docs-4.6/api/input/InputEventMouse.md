...
- Source: InputEventMouse.xml
- Inherits: InputEventWithModifiers
- Inheritance Chain: InputEventMouse -> InputEventWithModifiers -> InputEventFromWindow -> InputEvent -> Resource -> RefCounted -> Object
...
- button_mask: int (MouseButtonMask) = 0 [set set_button_mask; get get_button_mask]
  The mouse button mask identifier, one of or a bitwise combination of the MouseButton button masks.

- global_position: Vector2 = Vector2(0, 0) [set set_global_position; get get_global_position]
