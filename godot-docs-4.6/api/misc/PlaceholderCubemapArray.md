...
- Source: PlaceholderCubemapArray.xml
- Inherits: PlaceholderTextureLayered
- Inheritance Chain: PlaceholderCubemapArray -> PlaceholderTextureLayered -> TextureLayered -> Texture -> Resource -> RefCounted -> Object
