...
- Source: UndoRedo.xml
- Inherits: Object
- Inheritance Chain: UndoRedo -> Object
...
clear_history(increase_version: bool = true) -> void
commit_action(execute: bool = true) -> void
create_action(name: String, merge_mode: int (UndoRedo.MergeMode) = 0, backward_undo_ops: bool = false) -> void
end_force_keep_in_merge_ends() -> void
get_action_name(id: int) -> String
get_current_action() -> int
get_current_action_name() -> String [const]
...
- clear_history(increase_version: bool = true) -> void
  Clear the undo/redo history and associated references. Passing false to increase_version will prevent the version number from increasing when the history is cleared.
...
- max_steps: int = 0 [set set_max_steps; get get_max_steps]
