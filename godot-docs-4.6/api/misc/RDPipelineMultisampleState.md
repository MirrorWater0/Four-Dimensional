...
- Source: RDPipelineMultisampleState.xml
- Inherits: RefCounted
- Inheritance Chain: RDPipelineMultisampleState -> RefCounted -> Object
...
- enable_alpha_to_coverage: bool = false [set set_enable_alpha_to_coverage; get get_enable_alpha_to_coverage]
...
- enable_alpha_to_one: bool = false [set set_enable_alpha_to_one; get get_enable_alpha_to_one]
...
- enable_sample_shading: bool = false [set set_enable_sample_shading; get get_enable_sample_shading]
...
- min_sample_shading: float = 0.0 [set set_min_sample_shading; get get_min_sample_shading]
...
- sample_count: int (RenderingDevice.TextureSamples) = 0 [set set_sample_count; get get_sample_count]
...
- sample_masks: int[] = [] [set set_sample_masks; get get_sample_masks]
