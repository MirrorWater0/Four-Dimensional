...
- Source: RDPipelineDepthStencilState.xml
- Inherits: RefCounted
- Inheritance Chain: RDPipelineDepthStencilState -> RefCounted -> Object
...
- back_op_compare: int (RenderingDevice.CompareOperator) = 7 [set set_back_op_compare; get get_back_op_compare]
  The method used for comparing the previous back stencil value and back_op_reference.

- back_op_compare_mask: int = 0 [set set_back_op_compare_mask; get get_back_op_compare_mask]
  Selects which bits from the back stencil value will be compared.

- back_op_depth_fail: int (RenderingDevice.StencilOperation) = 1 [set set_back_op_depth_fail; get get_back_op_depth_fail]
  The operation to perform on the stencil buffer for back pixels that pass the stencil test but fail the depth test.

- back_op_fail: int (RenderingDevice.StencilOperation) = 1 [set set_back_op_fail; get get_back_op_fail]
  The operation to perform on the stencil buffer for back pixels that fail the stencil test.

- back_op_pass: int (RenderingDevice.StencilOperation) = 1 [set set_back_op_pass; get get_back_op_pass]
  The operation to perform on the stencil buffer for back pixels that pass the stencil test.

- back_op_reference: int = 0 [set set_back_op_reference; get get_back_op_reference]
  The value the previous back stencil value will be compared to.

- back_op_write_mask: int = 0 [set set_back_op_write_mask; get get_back_op_write_mask]
  Selects which bits from the back stencil value will be changed.

- depth_compare_operator: int (RenderingDevice.CompareOperator) = 7 [set set_depth_compare_operator; get get_depth_compare_operator]
  The method used for comparing the previous and current depth values.

- depth_range_max: float = 0.0 [set set_depth_range_max; get get_depth_range_max]
  The maximum depth that returns true for enable_depth_range.

- depth_range_min: float = 0.0 [set set_depth_range_min; get get_depth_range_min]
  The minimum depth that returns true for enable_depth_range.

- enable_depth_range: bool = false [set set_enable_depth_range; get get_enable_depth_range]
...
- enable_depth_test: bool = false [set set_enable_depth_test; get get_enable_depth_test]
...
- enable_depth_write: bool = false [set set_enable_depth_write; get get_enable_depth_write]
  If true, writes to the depth buffer whenever the depth test returns true. Only works when enable_depth_test is also true.

- enable_stencil: bool = false [set set_enable_stencil; get get_enable_stencil]
...
- front_op_compare: int (RenderingDevice.CompareOperator) = 7 [set set_front_op_compare; get get_front_op_compare]
  The method used for comparing the previous front stencil value and front_op_reference.

- front_op_compare_mask: int = 0 [set set_front_op_compare_mask; get get_front_op_compare_mask]
  Selects which bits from the front stencil value will be compared.

- front_op_depth_fail: int (RenderingDevice.StencilOperation) = 1 [set set_front_op_depth_fail; get get_front_op_depth_fail]
  The operation to perform on the stencil buffer for front pixels that pass the stencil test but fail the depth test.

- front_op_fail: int (RenderingDevice.StencilOperation) = 1 [set set_front_op_fail; get get_front_op_fail]
  The operation to perform on the stencil buffer for front pixels that fail the stencil test.

- front_op_pass: int (RenderingDevice.StencilOperation) = 1 [set set_front_op_pass; get get_front_op_pass]
  The operation to perform on the stencil buffer for front pixels that pass the stencil test.

- front_op_reference: int = 0 [set set_front_op_reference; get get_front_op_reference]
  The value the previous front stencil value will be compared to.

- front_op_write_mask: int = 0 [set set_front_op_write_mask; get get_front_op_write_mask]
