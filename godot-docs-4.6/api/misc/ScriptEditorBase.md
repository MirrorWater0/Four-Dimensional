...
- Source: ScriptEditorBase.xml
- Inherits: VBoxContainer
- Inheritance Chain: ScriptEditorBase -> VBoxContainer -> BoxContainer -> Container -> Control -> CanvasItem -> Node -> Object
