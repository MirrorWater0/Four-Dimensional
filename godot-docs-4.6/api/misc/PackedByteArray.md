...
bswap16(offset: int = 0, count: int = -1) -> void
bswap32(offset: int = 0, count: int = -1) -> void
bswap64(offset: int = 0, count: int = -1) -> void
clear() -> void
compress(compression_mode: int = 0) -> PackedByteArray [const]
count(value: int) -> int [const]
decode_double(byte_offset: int) -> float [const]
decode_float(byte_offset: int) -> float [const]
decode_half(byte_offset: int) -> float [const]
decode_s8(byte_offset: int) -> int [const]
decode_s16(byte_offset: int) -> int [const]
decode_s32(byte_offset: int) -> int [const]
decode_s64(byte_offset: int) -> int [const]
decode_u8(byte_offset: int) -> int [const]
decode_u16(byte_offset: int) -> int [const]
decode_u32(byte_offset: int) -> int [const]
decode_u64(byte_offset: int) -> int [const]
decode_var(byte_offset: int, allow_objects: bool = false) -> Variant [const]
decode_var_size(byte_offset: int, allow_objects: bool = false) -> int [const]
decompress(buffer_size: int, compression_mode: int = 0) -> PackedByteArray [const]
decompress_dynamic(max_output_size: int, compression_mode: int = 0) -> PackedByteArray [const]
duplicate() -> PackedByteArray [const]
...
get_string_from_ascii() -> String [const]
get_string_from_multibyte_char(encoding: String = "") -> String [const]
get_string_from_utf8() -> String [const]
get_string_from_utf16() -> String [const]
get_string_from_utf32() -> String [const]
get_string_from_wchar() -> String [const]
has(value: int) -> bool [const]
has_encoded_var(byte_offset: int, allow_objects: bool = false) -> bool [const]
hex_encode() -> String [const]
...
size() -> int [const]
slice(begin: int, end: int = 2147483647) -> PackedByteArray [const]
sort() -> void
to_color_array() -> PackedColorArray [const]
to_float32_array() -> PackedFloat32Array [const]
to_float64_array() -> PackedFloat64Array [const]
to_int32_array() -> PackedInt32Array [const]
to_int64_array() -> PackedInt64Array [const]
to_vector2_array() -> PackedVector2Array [const]
to_vector3_array() -> PackedVector3Array [const]
to_vector4_array() -> PackedVector4Array [const]
```
...
- PackedByteArray(from: PackedByteArray) -> PackedByteArray
  Constructs a PackedByteArray as a copy of the given PackedByteArray.

- PackedByteArray(from: Array) -> PackedByteArray
...
- get(index: int) -> int [const]
  Returns the byte at the given index in the array. If index is out-of-bounds or negative, this method fails and returns 0. This method is similar (but not identical) to the [] operator. Most notably, when this method fails, it doesn't pause project execution if run from the editor.
...
- operator [](index: int) -> int
  Returns the byte at index index. Negative indices can be used to access the elements starting from the end. Using index out of array's bounds will result in an error. Note that the byte is returned as a 64-bit int.
