...
- Source: Viewport.xml
- Inherits: Node
- Inheritance Chain: Viewport -> Node -> Object
...
```
[methods]
find_world_2d() -> World2D [const]
find_world_3d() -> World3D [const]
get_audio_listener_2d() -> AudioListener2D [const]
get_audio_listener_3d() -> AudioListener3D [const]
get_camera_2d() -> Camera2D [const]
get_camera_3d() -> Camera3D [const]
get_canvas_cull_mask_bit(layer: int) -> bool [const]
get_embedded_subwindows() -> Window[] [const]
get_final_transform() -> Transform2D [const]
get_mouse_position() -> Vector2 [const]
get_oversampling() -> float [const]
get_positional_shadow_atlas_quadrant_subdiv(quadrant: int) -> int (Viewport.PositionalShadowAtlasQuadrantSubdiv) [const]
get_render_info(type: int (Viewport.RenderInfoType), info: int (Viewport.RenderInfo)) -> int
get_screen_transform() -> Transform2D [const]
get_stretch_transform() -> Transform2D [const]
get_texture() -> ViewportTexture [const]
get_viewport_rid() -> RID [const]
get_visible_rect() -> Rect2 [const]
gui_cancel_drag() -> void
gui_get_drag_data() -> Variant [const]
gui_get_drag_description() -> String [const]
gui_get_focus_owner() -> Control [const]
gui_get_hovered_control() -> Control [const]
gui_is_drag_successful() -> bool [const]
gui_is_dragging() -> bool [const]
gui_release_focus() -> void
gui_set_drag_description(description: String) -> void
is_input_handled() -> bool [const]
notify_mouse_entered() -> void
notify_mouse_exited() -> void
push_input(event: InputEvent, in_local_coords: bool = false) -> void
push_text_input(text: String) -> void
push_unhandled_input(event: InputEvent, in_local_coords: bool = false) -> void
set_canvas_cull_mask_bit(layer: int, enable: bool) -> void
set_input_as_handled() -> void
set_positional_shadow_atlas_quadrant_subdiv(quadrant: int, subdiv: int (Viewport.PositionalShadowAtlasQuadrantSubdiv)) -> void
...
- gui_is_dragging() -> bool [const]
  Returns true if a drag operation is currently ongoing and where the drop action could happen in this viewport. Alternative to Node.NOTIFICATION_DRAG_BEGIN and Node.NOTIFICATION_DRAG_END when you prefer polling the value.
...
- set_input_as_handled() -> void
  Stops the input from propagating further up the SceneTree. **Note:** This does not affect the methods in Input, only the way events are propagated.
...
- anisotropic_filtering_level: int (Viewport.AnisotropicFiltering) = 2 [set set_anisotropic_filtering_level; get get_anisotropic_filtering_level]
...
- audio_listener_enable_2d: bool = false [set set_as_audio_listener_2d; get is_audio_listener_2d]
  If true, the viewport will process 2D audio streams.

- audio_listener_enable_3d: bool = false [set set_as_audio_listener_3d; get is_audio_listener_3d]
  If true, the viewport will process 3D audio streams.

- canvas_cull_mask: int = 4294967295 [set set_canvas_cull_mask; get get_canvas_cull_mask]
  The rendering layers in which this Viewport renders CanvasItem nodes. **Note:** A CanvasItem does not inherit its parents' visibility layers. See CanvasItem.visibility_layer's description for details.

- canvas_item_default_texture_filter: int (Viewport.DefaultCanvasItemTextureFilter) = 1 [set set_default_canvas_item_texture_filter; get get_default_canvas_item_texture_filter]
  The default filter mode used by CanvasItem nodes in this viewport.

- canvas_item_default_texture_repeat: int (Viewport.DefaultCanvasItemTextureRepeat) = 0 [set set_default_canvas_item_texture_repeat; get get_default_canvas_item_texture_repeat]
  The default repeat mode used by CanvasItem nodes in this viewport.

- canvas_transform: Transform2D [set set_canvas_transform; get get_canvas_transform]
...
- debug_draw: int (Viewport.DebugDraw) = 0 [set set_debug_draw; get get_debug_draw]
  The overlay mode for test rendered geometry in debug purposes.

- disable_3d: bool = false [set set_disable_3d; get is_3d_disabled]
  Disable 3D rendering (but keep 2D rendering).

- fsr_sharpness: float = 0.2 [set set_fsr_sharpness; get get_fsr_sharpness]
...
- global_canvas_transform: Transform2D [set set_global_canvas_transform; get get_global_canvas_transform]
  The global canvas transform of the viewport. The canvas transform is relative to this.

- gui_disable_input: bool = false [set set_disable_input; get is_input_disabled]
  If true, the viewport will not receive input events.

- gui_drag_threshold: int = 10 [set set_drag_threshold; get get_drag_threshold]
  The minimum distance the mouse cursor must move while pressed before a drag operation begins.

- gui_embed_subwindows: bool = false [set set_embedding_subwindows; get is_embedding_subwindows]
...
- gui_snap_controls_to_pixels: bool = true [set set_snap_controls_to_pixels; get is_snap_controls_to_pixels_enabled]
  If true, the GUI controls on the viewport will lay pixel perfectly.

- handle_input_locally: bool = true [set set_handle_input_locally; get is_handling_input_locally]
...
- mesh_lod_threshold: float = 1.0 [set set_mesh_lod_threshold; get get_mesh_lod_threshold]
...
- msaa_2d: int (Viewport.MSAA) = 0 [set set_msaa_2d; get get_msaa_2d]
...
- msaa_3d: int (Viewport.MSAA) = 0 [set set_msaa_3d; get get_msaa_3d]
...
- oversampling: bool = true [set set_use_oversampling; get is_using_oversampling]
...
- oversampling_override: float = 0.0 [set set_oversampling_override; get get_oversampling_override]
...
- own_world_3d: bool = false [set set_use_own_world_3d; get is_using_own_world_3d]
  If true, the viewport will use a unique copy of the World3D defined in world_3d.

- physics_interpolation_mode: int (Node.PhysicsInterpolationMode) = 1 [set set_physics_interpolation_mode; get get_physics_interpolation_mode; override Node]

- physics_object_picking: bool = false [set set_physics_object_picking; get get_physics_object_picking]
...
- physics_object_picking_first_only: bool = false [set set_physics_object_picking_first_only; get get_physics_object_picking_first_only]
...
- physics_object_picking_sort: bool = false [set set_physics_object_picking_sort; get get_physics_object_picking_sort]
...
- positional_shadow_atlas_16_bits: bool = true [set set_positional_shadow_atlas_16_bits; get get_positional_shadow_atlas_16_bits]
  Use 16 bits for the omni/spot shadow depth map. Enabling this results in shadows having less precision and may result in shadow acne, but can lead to performance improvements on some devices.

- positional_shadow_atlas_quad_0: int (Viewport.PositionalShadowAtlasQuadrantSubdiv) = 2 [set set_positional_shadow_atlas_quadrant_subdiv; get get_positional_shadow_atlas_quadrant_subdiv]
  The subdivision amount of the first quadrant on the shadow atlas.

- positional_shadow_atlas_quad_1: int (Viewport.PositionalShadowAtlasQuadrantSubdiv) = 2 [set set_positional_shadow_atlas_quadrant_subdiv; get get_positional_shadow_atlas_quadrant_subdiv]
  The subdivision amount of the second quadrant on the shadow atlas.

- positional_shadow_atlas_quad_2: int (Viewport.PositionalShadowAtlasQuadrantSubdiv) = 3 [set set_positional_shadow_atlas_quadrant_subdiv; get get_positional_shadow_atlas_quadrant_subdiv]
  The subdivision amount of the third quadrant on the shadow atlas.

- positional_shadow_atlas_quad_3: int (Viewport.PositionalShadowAtlasQuadrantSubdiv) = 4 [set set_positional_shadow_atlas_quadrant_subdiv; get get_positional_shadow_atlas_quadrant_subdiv]
  The subdivision amount of the fourth quadrant on the shadow atlas.

- positional_shadow_atlas_size: int = 2048 [set set_positional_shadow_atlas_size; get get_positional_shadow_atlas_size]
...
- scaling_3d_mode: int (Viewport.Scaling3DMode) = 0 [set set_scaling_3d_mode; get get_scaling_3d_mode]
...
- scaling_3d_scale: float = 1.0 [set set_scaling_3d_scale; get get_scaling_3d_scale]
...
- screen_space_aa: int (Viewport.ScreenSpaceAA) = 0 [set set_screen_space_aa; get get_screen_space_aa]
...
- sdf_oversize: int (Viewport.SDFOversize) = 1 [set set_sdf_oversize; get get_sdf_oversize]
...
- sdf_scale: int (Viewport.SDFScale) = 1 [set set_sdf_scale; get get_sdf_scale]
...
- snap_2d_transforms_to_pixel: bool = false [set set_snap_2d_transforms_to_pixel; get is_snap_2d_transforms_to_pixel_enabled]
...
- snap_2d_vertices_to_pixel: bool = false [set set_snap_2d_vertices_to_pixel; get is_snap_2d_vertices_to_pixel_enabled]
...
- transparent_bg: bool = false [set set_transparent_background; get has_transparent_background]
...
- use_debanding: bool = false [set set_use_debanding; get is_using_debanding]
...
- use_hdr_2d: bool = false [set set_use_hdr_2d; get is_using_hdr_2d]
...
- use_occlusion_culling: bool = false [set set_use_occlusion_culling; get is_using_occlusion_culling]
...
- use_taa: bool = false [set set_use_taa; get is_using_taa]
  Enables temporal antialiasing for this viewport. TAA works by jittering the camera and accumulating the images of the last rendered frames, motion vector rendering is used to account for camera and object motion. **Note:** The implementation is not complete yet, some visual instances such as particles and skinned meshes may show artifacts. See also ProjectSettings.rendering/anti_aliasing/quality/use_taa and RenderingServer.viewport_set_use_taa().

- use_xr: bool = false [set set_use_xr; get is_using_xr]
...
- SCALING_3D_MODE_METALFX_SPATIAL = 3
  Use the [MetalFX spatial upscaler](https://developer.apple.com/documentation/metalfx/mtlfxspatialscaler#overview) for the viewport's 3D buffer. The amount of scaling can be set using scaling_3d_scale. Values less than 1.0 will result in the viewport being upscaled using MetalFX. Values greater than 1.0 are not supported and bilinear downsampling will be used instead. A value of 1.0 disables scaling. More information: MetalFX(https://developer.apple.com/documentation/metalfx). **Note:** Only supported when the Metal rendering driver is in use, which limits this scaling mode to macOS and iOS.

- SCALING_3D_MODE_METALFX_TEMPORAL = 4
  Use the [MetalFX temporal upscaler](https://developer.apple.com/documentation/metalfx/mtlfxtemporalscaler#overview) for the viewport's 3D buffer. The amount of scaling can be set using scaling_3d_scale. To determine the minimum input scale, use the RenderingDevice.limit_get() method with RenderingDevice.LIMIT_METALFX_TEMPORAL_SCALER_MIN_SCALE. Values less than 1.0 will result in the viewport being upscaled using MetalFX. Values greater than 1.0 are not supported and bilinear downsampling will be used instead. A value of 1.0 will use MetalFX at native resolution as a TAA solution. More information: MetalFX(https://developer.apple.com/documentation/metalfx). **Note:** Only supported when the Metal rendering driver is in use, which limits this scaling mode to macOS and iOS.
