...
- Source: ProceduralSkyMaterial.xml
- Inherits: Material
- Inheritance Chain: ProceduralSkyMaterial -> Material -> Resource -> RefCounted -> Object
...
- ground_bottom_color: Color = Color(0.2, 0.169, 0.133, 1) [set set_ground_bottom_color; get get_ground_bottom_color]
  Color of the ground at the bottom. Blends with ground_horizon_color.

- ground_curve: float = 0.02 [set set_ground_curve; get get_ground_curve]
  How quickly the ground_horizon_color fades into the ground_bottom_color.

- ground_energy_multiplier: float = 1.0 [set set_ground_energy_multiplier; get get_ground_energy_multiplier]
  Multiplier for ground color. A higher value will make the ground brighter.

- ground_horizon_color: Color = Color(0.6463, 0.6558, 0.6708, 1) [set set_ground_horizon_color; get get_ground_horizon_color]
  Color of the ground at the horizon. Blends with ground_bottom_color.

- sky_cover: Texture2D [set set_sky_cover; get get_sky_cover]
...
- sky_cover_modulate: Color = Color(1, 1, 1, 1) [set set_sky_cover_modulate; get get_sky_cover_modulate]
...
- sky_curve: float = 0.15 [set set_sky_curve; get get_sky_curve]
  How quickly the sky_horizon_color fades into the sky_top_color.

- sky_energy_multiplier: float = 1.0 [set set_sky_energy_multiplier; get get_sky_energy_multiplier]
  Multiplier for sky color. A higher value will make the sky brighter.

- sky_horizon_color: Color = Color(0.6463, 0.6558, 0.6708, 1) [set set_sky_horizon_color; get get_sky_horizon_color]
  Color of the sky at the horizon. Blends with sky_top_color.

- sky_top_color: Color = Color(0.385, 0.454, 0.55, 1) [set set_sky_top_color; get get_sky_top_color]
  Color of the sky at the top. Blends with sky_horizon_color.

- sun_angle_max: float = 30.0 [set set_sun_angle_max; get get_sun_angle_max]
  Distance from center of sun where it fades out completely.

- sun_curve: float = 0.15 [set set_sun_curve; get get_sun_curve]
