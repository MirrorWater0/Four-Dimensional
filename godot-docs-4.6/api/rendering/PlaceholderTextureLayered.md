...
- Source: PlaceholderTextureLayered.xml
- Inherits: TextureLayered
- Inheritance Chain: PlaceholderTextureLayered -> TextureLayered -> Texture -> Resource -> RefCounted -> Object
...
- layers: int = 1 [set set_layers; get get_layers]
  The number of layers in the texture array.

- size: Vector2i = Vector2i(1, 1) [set set_size; get get_size]
