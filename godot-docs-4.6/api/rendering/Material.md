...
- Source: Material.xml
- Inherits: Resource
- Inheritance Chain: Material -> Resource -> RefCounted -> Object
...
```
[methods]
_can_do_next_pass() -> bool [virtual const]
_can_use_render_priority() -> bool [virtual const]
_get_shader_mode() -> int (Shader.Mode) [virtual required const]
_get_shader_rid() -> RID [virtual required const]
...
- next_pass: Material [set set_next_pass; get get_next_pass]
...
- render_priority: int [set set_render_priority; get get_render_priority]
