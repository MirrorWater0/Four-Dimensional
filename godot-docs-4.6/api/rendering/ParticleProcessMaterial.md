...
- Source: ParticleProcessMaterial.xml
- Inherits: Material
- Inheritance Chain: ParticleProcessMaterial -> Material -> Resource -> RefCounted -> Object
...
```
[methods]
get_param(param: int (ParticleProcessMaterial.Parameter)) -> Vector2 [const]
get_param_max(param: int (ParticleProcessMaterial.Parameter)) -> float [const]
get_param_min(param: int (ParticleProcessMaterial.Parameter)) -> float [const]
get_param_texture(param: int (ParticleProcessMaterial.Parameter)) -> Texture2D [const]
get_particle_flag(particle_flag: int (ParticleProcessMaterial.ParticleFlags)) -> bool [const]
set_param(param: int (ParticleProcessMaterial.Parameter), value: Vector2) -> void
set_param_max(param: int (ParticleProcessMaterial.Parameter), value: float) -> void
set_param_min(param: int (ParticleProcessMaterial.Parameter), value: float) -> void
set_param_texture(param: int (ParticleProcessMaterial.Parameter), texture: Texture2D) -> void
set_particle_flag(particle_flag: int (ParticleProcessMaterial.ParticleFlags), enable: bool) -> void
...
- get_param(param: int (ParticleProcessMaterial.Parameter)) -> Vector2 [const]
  Returns the minimum and maximum values of the given param as a vector. The x component of the returned vector corresponds to minimum and the y component corresponds to maximum.
...
- set_param(param: int (ParticleProcessMaterial.Parameter), value: Vector2) -> void
  Sets the minimum and maximum values of the given param. The x component of the argument vector corresponds to minimum and the y component corresponds to maximum.
...
- angular_velocity_curve: Texture2D [set set_param_texture; get get_param_texture]
...
- anim_offset_curve: Texture2D [set set_param_texture; get get_param_texture]
...
- anim_speed_curve: Texture2D [set set_param_texture; get get_param_texture]
...
- attractor_interaction_enabled: bool = true [set set_attractor_interaction_enabled; get is_attractor_interaction_enabled]
...
- collision_bounce: float [set set_collision_bounce; get get_collision_bounce]
...
- collision_friction: float [set set_collision_friction; get get_collision_friction]
...
- collision_mode: int (ParticleProcessMaterial.CollisionMode) = 0 [set set_collision_mode; get get_collision_mode]
...
- collision_use_scale: bool = false [set set_collision_use_scale; get is_collision_using_scale]
...
- color_initial_ramp: Texture2D [set set_color_initial_ramp; get get_color_initial_ramp]
...
- color_ramp: Texture2D [set set_color_ramp; get get_color_ramp]
...
- damping_curve: Texture2D [set set_param_texture; get get_param_texture]
...
- directional_velocity_curve: Texture2D [set set_param_texture; get get_param_texture]
...
- directional_velocity_max: float [set set_param_max; get get_param_max]
...
- directional_velocity_min: float [set set_param_min; get get_param_min]
...
- emission_box_extents: Vector3 [set set_emission_box_extents; get get_emission_box_extents]
  The box's extents if emission_shape is set to EMISSION_SHAPE_BOX. **Note:** emission_box_extents starts from the center point and applies the X, Y, and Z values in both directions. The size is twice the area of the extents.

- emission_color_texture: Texture2D [set set_emission_color_texture; get get_emission_color_texture]
...
- emission_point_count: int [set set_emission_point_count; get get_emission_point_count]
  The number of emission points if emission_shape is set to EMISSION_SHAPE_POINTS or EMISSION_SHAPE_DIRECTED_POINTS.

- emission_point_texture: Texture2D [set set_emission_point_texture; get get_emission_point_texture]
...
- emission_shape: int (ParticleProcessMaterial.EmissionShape) = 0 [set set_emission_shape; get get_emission_shape]
  Particles will be emitted inside this region.

- emission_shape_offset: Vector3 = Vector3(0, 0, 0) [set set_emission_shape_offset; get get_emission_shape_offset]
  The offset for the emission_shape, in local space.

- emission_shape_scale: Vector3 = Vector3(1, 1, 1) [set set_emission_shape_scale; get get_emission_shape_scale]
...
- hue_variation_curve: Texture2D [set set_param_texture; get get_param_texture]
...
- inherit_velocity_ratio: float = 0.0 [set set_inherit_velocity_ratio; get get_inherit_velocity_ratio]
...
- linear_accel_curve: Texture2D [set set_param_texture; get get_param_texture]
...
- orbit_velocity_curve: Texture2D [set set_param_texture; get get_param_texture]
...
- particle_flag_damping_as_friction: bool = false [set set_particle_flag; get get_particle_flag]
...
- radial_accel_curve: Texture2D [set set_param_texture; get get_param_texture]
...
- radial_velocity_curve: Texture2D [set set_param_texture; get get_param_texture]
...
- radial_velocity_max: float = 0.0 [set set_param_max; get get_param_max]
...
- radial_velocity_min: float = 0.0 [set set_param_min; get get_param_min]
...
- scale_curve: Texture2D [set set_param_texture; get get_param_texture]
...
- scale_max: float = 1.0 [set set_param_max; get get_param_max]
  Maximum initial scale applied to each particle.

- scale_min: float = 1.0 [set set_param_min; get get_param_min]
  Minimum equivalent of scale_max.

- scale_over_velocity_curve: Texture2D [set set_param_texture; get get_param_texture]
  Either a CurveTexture or a CurveXYZTexture that scales each particle based on its velocity.

- scale_over_velocity_max: float = 0.0 [set set_param_max; get get_param_max]
...
- scale_over_velocity_min: float = 0.0 [set set_param_min; get get_param_min]
...
- sub_emitter_amount_at_collision: int [set set_sub_emitter_amount_at_collision; get get_sub_emitter_amount_at_collision]
...
- sub_emitter_amount_at_end: int [set set_sub_emitter_amount_at_end; get get_sub_emitter_amount_at_end]
  The amount of particles to spawn from the subemitter node when the particle expires. **Note:** This value shouldn't exceed GPUParticles2D.amount or GPUParticles3D.amount defined on the *subemitter node* (not the main node), relative to the subemitter's particle lifetime. If the number of particles is exceeded, no new particles will spawn from the subemitter until enough particles have expired.

- sub_emitter_amount_at_start: int [set set_sub_emitter_amount_at_start; get get_sub_emitter_amount_at_start]
  The amount of particles to spawn from the subemitter node when the particle spawns. **Note:** This value shouldn't exceed GPUParticles2D.amount or GPUParticles3D.amount defined on the *subemitter node* (not the main node), relative to the subemitter's particle lifetime. If the number of particles is exceeded, no new particles will spawn from the subemitter until enough particles have expired.

- sub_emitter_frequency: float [set set_sub_emitter_frequency; get get_sub_emitter_frequency]
...
- sub_emitter_keep_velocity: bool = false [set set_sub_emitter_keep_velocity; get get_sub_emitter_keep_velocity]
  If true, the subemitter inherits the parent particle's velocity when it spawns.

- sub_emitter_mode: int (ParticleProcessMaterial.SubEmitterMode) = 0 [set set_sub_emitter_mode; get get_sub_emitter_mode]
  The particle subemitter mode (see GPUParticles2D.sub_emitter and GPUParticles3D.sub_emitter).

- tangential_accel_curve: Texture2D [set set_param_texture; get get_param_texture]
...
- turbulence_enabled: bool = false [set set_turbulence_enabled; get get_turbulence_enabled]
...
- turbulence_influence_max: float = 0.1 [set set_param_max; get get_param_max]
...
- turbulence_influence_min: float = 0.1 [set set_param_min; get get_param_min]
...
- turbulence_influence_over_life: Texture2D [set set_param_texture; get get_param_texture]
  Each particle's amount of turbulence will be influenced along this CurveTexture over its life time.

- turbulence_initial_displacement_max: float = 0.0 [set set_param_max; get get_param_max]
...
- turbulence_initial_displacement_min: float = 0.0 [set set_param_min; get get_param_min]
...
- turbulence_noise_scale: float = 9.0 [set set_turbulence_noise_scale; get get_turbulence_noise_scale]
...
- turbulence_noise_speed: Vector3 = Vector3(0, 0, 0) [set set_turbulence_noise_speed; get get_turbulence_noise_speed]
...
- turbulence_noise_speed_random: float = 0.2 [set set_turbulence_noise_speed_random; get get_turbulence_noise_speed_random]
...
- turbulence_noise_strength: float = 1.0 [set set_turbulence_noise_strength; get get_turbulence_noise_strength]
  The turbulence noise strength. Increasing this will result in a stronger, more contrasting, flow pattern.

- velocity_limit_curve: Texture2D [set set_velocity_limit_curve; get get_velocity_limit_curve]
  A CurveTexture that defines the maximum velocity of a particle during its lifetime.

- velocity_pivot: Vector3 = Vector3(0, 0, 0) [set set_velocity_pivot; get get_velocity_pivot]
