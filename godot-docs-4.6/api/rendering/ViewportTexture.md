...
- Source: ViewportTexture.xml
- Inherits: Texture2D
- Inheritance Chain: ViewportTexture -> Texture2D -> Texture -> Resource -> RefCounted -> Object
...
- viewport_path: NodePath = NodePath("") [set set_viewport_path_in_scene; get get_viewport_path_in_scene]
