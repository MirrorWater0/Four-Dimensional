...
- Name: FogMaterial
- Source: FogMaterial.xml
- Inherits: Material
- Inheritance Chain: FogMaterial -> Material -> Resource -> RefCounted -> Object
...
A Material resource that can be used by FogVolumes to draw volumetric effects. If you need more advanced effects, use a custom [fog shader]($DOCS_URL/tutorials/shaders/shader_reference/fog_shader.html).
...
- albedo: Color = Color(1, 1, 1, 1) [set set_albedo; get get_albedo]
...
- density: float = 1.0 [set set_density; get get_density]
...
- density_texture: Texture3D [set set_density_texture; get get_density_texture]
...
- edge_fade: float = 0.1 [set set_edge_fade; get get_edge_fade]
...
- height_falloff: float = 0.0 [set set_height_falloff; get get_height_falloff]
