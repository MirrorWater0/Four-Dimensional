...
- Source: Sky.xml
- Inherits: Resource
- Inheritance Chain: Sky -> Resource -> RefCounted -> Object
...
- process_mode: int (Sky.ProcessMode) = 0 [set set_process_mode; get get_process_mode]
...
- radiance_size: int (Sky.RadianceSize) = 3 [set set_radiance_size; get get_radiance_size]
...
- sky_material: Material [set set_material; get get_material]
