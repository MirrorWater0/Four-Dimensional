...
- Source: RenderSceneBuffersRD.xml
- Inherits: RenderSceneBuffers
- Inheritance Chain: RenderSceneBuffersRD -> RenderSceneBuffers -> RefCounted -> Object
...
create_texture(context: StringName, name: StringName, data_format: int (RenderingDevice.DataFormat), usage_bits: int, texture_samples: int (RenderingDevice.TextureSamples), size: Vector2i, layers: int, mipmaps: int, unique: bool, discardable: bool) -> RID
...
get_fsr_sharpness() -> float [const]
get_internal_size() -> Vector2i [const]
get_msaa_3d() -> int (RenderingServer.ViewportMSAA) [const]
get_render_target() -> RID [const]
get_scaling_3d_mode() -> int (RenderingServer.ViewportScaling3DMode) [const]
get_screen_space_aa() -> int (RenderingServer.ViewportScreenSpaceAA) [const]
get_target_size() -> Vector2i [const]
get_texture(context: StringName, name: StringName) -> RID [const]
get_texture_format(context: StringName, name: StringName) -> RDTextureFormat [const]
get_texture_samples() -> int (RenderingDevice.TextureSamples) [const]
