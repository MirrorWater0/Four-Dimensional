...
- Name: SkeletonIK3D
- Source: SkeletonIK3D.xml
- Inherits: SkeletonModifier3D
- Inheritance Chain: SkeletonIK3D -> SkeletonModifier3D -> Node3D -> Node -> Object
...
```
[methods]
get_parent_skeleton() -> Skeleton3D [const]
is_running() -> bool
start(one_time: bool = false) -> void
stop() -> void
...
- interpolation: float [set set_interpolation; get get_interpolation]
...
- magnet: Vector3 = Vector3(0, 0, 0) [set set_magnet_position; get get_magnet_position]
...
- max_iterations: int = 10 [set set_max_iterations; get get_max_iterations]
  Number of iteration loops used by the IK solver to produce more accurate (and elegant) bone chain results.

- min_distance: float = 0.01 [set set_min_distance; get get_min_distance]
  The minimum distance between bone and goal target. If the distance is below this value, the IK solver stops further iterations.

- override_tip_basis: bool = true [set set_override_tip_basis; get is_override_tip_basis]
...
- target: Transform3D = Transform3D(1, 0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0) [set set_target_transform; get get_target_transform]
