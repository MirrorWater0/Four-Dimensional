...
- Source: Bone2D.xml
- Inherits: Node2D
- Inheritance Chain: Bone2D -> Node2D -> CanvasItem -> Node -> Object
...
[methods]
apply_rest() -> void
get_autocalculate_length_and_angle() -> bool [const]
get_bone_angle() -> float [const]
get_index_in_skeleton() -> int [const]
get_length() -> float [const]
get_skeleton_rest() -> Transform2D [const]
set_autocalculate_length_and_angle(auto_calculate: bool) -> void
...
- set_bone_angle(angle: float) -> void
  Sets the bone angle for the Bone2D. This is typically set to the rotation from the Bone2D to a child Bone2D node. **Note:** This is different from the Bone2D's rotation. The bone's angle is the rotation of the bone shown by the gizmo, which is unaffected by the Bone2D's Node2D.transform.
...
- rest: Transform2D = Transform2D(0, 0, 0, 0, 0, 0) [set set_rest; get get_rest]
