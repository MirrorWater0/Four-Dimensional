...
- Source: AnimationNodeSub2.xml
- Inherits: AnimationNodeSync
- Inheritance Chain: AnimationNodeSub2 -> AnimationNodeSync -> AnimationNode -> Resource -> RefCounted -> Object
...
- [AnimationTree]($DOCS_URL/tutorials/animation/animation_tree.html)
