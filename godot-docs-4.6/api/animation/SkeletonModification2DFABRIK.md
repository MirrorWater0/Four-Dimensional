...
- Source: SkeletonModification2DFABRIK.xml
- Inherits: SkeletonModification2D
- Inheritance Chain: SkeletonModification2DFABRIK -> SkeletonModification2D -> Resource -> RefCounted -> Object
...
```
[methods]
get_fabrik_joint_bone2d_node(joint_idx: int) -> NodePath [const]
get_fabrik_joint_bone_index(joint_idx: int) -> int [const]
get_fabrik_joint_magnet_position(joint_idx: int) -> Vector2 [const]
get_fabrik_joint_use_target_rotation(joint_idx: int) -> bool [const]
set_fabrik_joint_bone2d_node(joint_idx: int, bone2d_nodepath: NodePath) -> void
...
set_fabrik_joint_use_target_rotation(joint_idx: int, use_target_rotation: bool) -> void
...
- set_fabrik_joint_use_target_rotation(joint_idx: int, use_target_rotation: bool) -> void
  Sets whether the joint at joint_idx will use the target node's rotation rather than letting FABRIK rotate the node. **Note:** This option only works for the tip/final joint in the chain. For all other nodes, this option will be ignored.

## Properties

- fabrik_data_chain_length: int = 0 [set set_fabrik_data_chain_length; get get_fabrik_data_chain_length]
