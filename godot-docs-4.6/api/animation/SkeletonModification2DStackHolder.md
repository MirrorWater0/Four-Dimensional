...
- Source: SkeletonModification2DStackHolder.xml
- Inherits: SkeletonModification2D
- Inheritance Chain: SkeletonModification2DStackHolder -> SkeletonModification2D -> Resource -> RefCounted -> Object
...
```
[methods]
get_held_modification_stack() -> SkeletonModificationStack2D [const]
