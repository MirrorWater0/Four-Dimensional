...
- Source: SkeletonModification2DCCDIK.xml
- Inherits: SkeletonModification2D
- Inheritance Chain: SkeletonModification2DCCDIK -> SkeletonModification2D -> Resource -> RefCounted -> Object
...
```
[methods]
get_ccdik_joint_bone2d_node(joint_idx: int) -> NodePath [const]
get_ccdik_joint_bone_index(joint_idx: int) -> int [const]
get_ccdik_joint_constraint_angle_invert(joint_idx: int) -> bool [const]
get_ccdik_joint_constraint_angle_max(joint_idx: int) -> float [const]
get_ccdik_joint_constraint_angle_min(joint_idx: int) -> float [const]
get_ccdik_joint_enable_constraint(joint_idx: int) -> bool [const]
get_ccdik_joint_rotate_from_joint(joint_idx: int) -> bool [const]
set_ccdik_joint_bone2d_node(joint_idx: int, bone2d_nodepath: NodePath) -> void
set_ccdik_joint_bone_index(joint_idx: int, bone_idx: int) -> void
set_ccdik_joint_constraint_angle_invert(joint_idx: int, invert: bool) -> void
...
set_ccdik_joint_enable_constraint(joint_idx: int, enable_constraint: bool) -> void
set_ccdik_joint_rotate_from_joint(joint_idx: int, rotate_from_joint: bool) -> void
...
- set_ccdik_joint_constraint_angle_invert(joint_idx: int, invert: bool) -> void
  Sets whether the CCDIK joint at joint_idx uses an inverted joint constraint. An inverted joint constraint only constraints the CCDIK joint to the angles *outside of* the inputted minimum and maximum angles. For this reason, it is referred to as an inverted joint constraint, as it constraints the joint to the outside of the inputted values.
...
- ccdik_data_chain_length: int = 0 [set set_ccdik_data_chain_length; get get_ccdik_data_chain_length]
  The number of CCDIK joints in the CCDIK modification.

- target_nodepath: NodePath = NodePath("") [set set_target_node; get get_target_node]
  The NodePath to the node that is the target for the CCDIK modification. This node is what the CCDIK chain will attempt to rotate the bone chain to.

- tip_nodepath: NodePath = NodePath("") [set set_tip_node; get get_tip_node]
