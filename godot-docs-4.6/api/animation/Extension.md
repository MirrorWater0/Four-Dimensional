...
- Source: AnimationNodeExtension.xml
- Inherits: AnimationNode
- Inheritance Chain: AnimationNodeExtension -> AnimationNode -> Resource -> RefCounted -> Object
...
```
[methods]
_process_animation_node(playback_info: PackedFloat64Array, test_only: bool) -> PackedFloat32Array [virtual required]
