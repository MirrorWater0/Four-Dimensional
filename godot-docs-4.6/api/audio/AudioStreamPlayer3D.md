...
- Source: AudioStreamPlayer3D.xml
- Inherits: Node3D
- Inheritance Chain: AudioStreamPlayer3D -> Node3D -> Node -> Object
...
- attenuation_filter_cutoff_hz: float = 5000.0 [set set_attenuation_filter_cutoff_hz; get get_attenuation_filter_cutoff_hz]
...
- attenuation_filter_db: float = -24.0 [set set_attenuation_filter_db; get get_attenuation_filter_db]
  Amount how much the filter affects the loudness, in decibels.

- attenuation_model: int (AudioStreamPlayer3D.AttenuationModel) = 0 [set set_attenuation_model; get get_attenuation_model]
...
- doppler_tracking: int (AudioStreamPlayer3D.DopplerTracking) = 0 [set set_doppler_tracking; get get_doppler_tracking]
...
- emission_angle_degrees: float = 45.0 [set set_emission_angle; get get_emission_angle]
  The angle in which the audio reaches a listener unattenuated.

- emission_angle_enabled: bool = false [set set_emission_angle_enabled; get is_emission_angle_enabled]
  If true, the audio should be attenuated according to the direction of the sound.

- emission_angle_filter_attenuation_db: float = -12.0 [set set_emission_angle_filter_attenuation_db; get get_emission_angle_filter_attenuation_db]
  Attenuation factor used if listener is outside of emission_angle_degrees and emission_angle_enabled is set, in decibels.

- max_db: float = 3.0 [set set_max_db; get get_max_db]
...
- unit_size: float = 10.0 [set set_unit_size; get get_unit_size]
