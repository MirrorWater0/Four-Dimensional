...
- Source: KinematicCollision2D.xml
- Inherits: RefCounted
- Inheritance Chain: KinematicCollision2D -> RefCounted -> Object
...
```
[methods]
get_angle(up_direction: Vector2 = Vector2(0, -1)) -> float [const]
get_collider() -> Object [const]
get_collider_id() -> int [const]
get_collider_rid() -> RID [const]
get_collider_shape() -> Object [const]
get_collider_shape_index() -> int [const]
get_collider_velocity() -> Vector2 [const]
get_depth() -> float [const]
get_local_shape() -> Object [const]
get_normal() -> Vector2 [const]
get_position() -> Vector2 [const]
