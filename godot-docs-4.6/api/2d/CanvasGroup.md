...
- Name: CanvasGroup
- Source: CanvasGroup.xml
- Inherits: Node2D
- Inheritance Chain: CanvasGroup -> Node2D -> CanvasItem -> Node -> Object
...
- clear_margin: float = 10.0 [set set_clear_margin; get get_clear_margin]
...
- fit_margin: float = 10.0 [set set_fit_margin; get get_fit_margin]
...
- use_mipmaps: bool = false [set set_use_mipmaps; get is_using_mipmaps]
