...
- Name: ParallaxLayer
- Source: ParallaxLayer.xml
- Inherits: Node2D
- Inheritance Chain: ParallaxLayer -> Node2D -> CanvasItem -> Node -> Object
...
- motion_mirroring: Vector2 = Vector2(0, 0) [set set_mirroring; get get_mirroring]
...
- motion_offset: Vector2 = Vector2(0, 0) [set set_motion_offset; get get_motion_offset]
  The ParallaxLayer's offset relative to the parent ParallaxBackground's ParallaxBackground.scroll_offset.

- motion_scale: Vector2 = Vector2(1, 1) [set set_motion_scale; get get_motion_scale]
