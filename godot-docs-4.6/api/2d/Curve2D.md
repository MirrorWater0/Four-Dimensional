...
- Source: Curve2D.xml
- Inherits: Resource
- Inheritance Chain: Curve2D -> Resource -> RefCounted -> Object
...
```
[methods]
add_point(position: Vector2, in: Vector2 = Vector2(0, 0), out: Vector2 = Vector2(0, 0), index: int = -1) -> void
clear_points() -> void
get_baked_length() -> float [const]
get_baked_points() -> PackedVector2Array [const]
get_closest_offset(to_point: Vector2) -> float [const]
get_closest_point(to_point: Vector2) -> Vector2 [const]
get_point_in(idx: int) -> Vector2 [const]
get_point_out(idx: int) -> Vector2 [const]
get_point_position(idx: int) -> Vector2 [const]
remove_point(idx: int) -> void
sample(idx: int, t: float) -> Vector2 [const]
sample_baked(offset: float = 0.0, cubic: bool = false) -> Vector2 [const]
sample_baked_with_rotation(offset: float = 0.0, cubic: bool = false) -> Transform2D [const]
samplef(fofs: float) -> Vector2 [const]
...
tessellate(max_stages: int = 5, tolerance_degrees: float = 4) -> PackedVector2Array [const]
tessellate_even_length(max_stages: int = 5, tolerance_length: float = 20.0) -> PackedVector2Array [const]
...
- bake_interval: float = 5.0 [set set_bake_interval; get get_bake_interval]
