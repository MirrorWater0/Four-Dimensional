...
- Source: Camera2D.xml
- Inherits: Node2D
- Inheritance Chain: Camera2D -> Node2D -> CanvasItem -> Node -> Object
...
get_drag_margin(margin: int (Side)) -> float [const]
get_limit(margin: int (Side)) -> int [const]
get_screen_center_position() -> Vector2 [const]
get_screen_rotation() -> float [const]
get_target_position() -> Vector2 [const]
is_current() -> bool [const]
make_current() -> void
reset_smoothing() -> void
set_drag_margin(margin: int (Side), drag_margin: float) -> void
set_limit(margin: int (Side), limit: int) -> void
...
- align() -> void
  Aligns the camera to the tracked node. **Note:** Calling force_update_scroll() after this method is not required.
...
- get_screen_rotation() -> float [const]
  Returns the current screen rotation from this camera's point of view. **Note:** The screen rotation can be different from Node2D.global_rotation if the camera is rotating smoothly due to rotation_smoothing_enabled.
...
- anchor_mode: int (Camera2D.AnchorMode) = 1 [set set_anchor_mode; get get_anchor_mode]
...
- drag_bottom_margin: float = 0.2 [set set_drag_margin; get get_drag_margin]
...
- drag_horizontal_enabled: bool = false [set set_drag_horizontal_enabled; get is_drag_horizontal_enabled]
...
- drag_horizontal_offset: float = 0.0 [set set_drag_horizontal_offset; get get_drag_horizontal_offset]
...
- drag_left_margin: float = 0.2 [set set_drag_margin; get get_drag_margin]
  Left margin needed to drag the camera. A value of 1 makes the camera move only when reaching the left edge of the screen.

- drag_right_margin: float = 0.2 [set set_drag_margin; get get_drag_margin]
...
- drag_top_margin: float = 0.2 [set set_drag_margin; get get_drag_margin]
  Top margin needed to drag the camera. A value of 1 makes the camera move only when reaching the top edge of the screen.

- drag_vertical_enabled: bool = false [set set_drag_vertical_enabled; get is_drag_vertical_enabled]
...
- drag_vertical_offset: float = 0.0 [set set_drag_vertical_offset; get get_drag_vertical_offset]
...
- editor_draw_drag_margin: bool = false [set set_margin_drawing_enabled; get is_margin_drawing_enabled]
  If true, draws the camera's drag margin rectangle in the editor.

- editor_draw_limits: bool = false [set set_limit_drawing_enabled; get is_limit_drawing_enabled]
  If true, draws the camera's limits rectangle in the editor.

- editor_draw_screen: bool = true [set set_screen_drawing_enabled; get is_screen_drawing_enabled]
...
- ignore_rotation: bool = true [set set_ignore_rotation; get is_ignoring_rotation]
  If true, the camera's rendered view is not affected by its Node2D.rotation and Node2D.global_rotation.

- limit_bottom: int = 10000000 [set set_limit; get get_limit]
...
- limit_enabled: bool = true [set set_limit_enabled; get is_limit_enabled]
...
- limit_smoothed: bool = false [set set_limit_smoothing_enabled; get is_limit_smoothing_enabled]
...
- limit_top: int = -10000000 [set set_limit; get get_limit]
...
- position_smoothing_enabled: bool = false [set set_position_smoothing_enabled; get is_position_smoothing_enabled]
  If true, the camera's view smoothly moves towards its target position at position_smoothing_speed.

- position_smoothing_speed: float = 5.0 [set set_position_smoothing_speed; get get_position_smoothing_speed]
  Speed in pixels per second of the camera's smoothing effect when position_smoothing_enabled is true.

- process_callback: int (Camera2D.Camera2DProcessCallback) = 1 [set set_process_callback; get get_process_callback]
  The camera's process callback.

- rotation_smoothing_enabled: bool = false [set set_rotation_smoothing_enabled; get is_rotation_smoothing_enabled]
...
- rotation_smoothing_speed: float = 5.0 [set set_rotation_smoothing_speed; get get_rotation_smoothing_speed]
  The angular, asymptotic speed of the camera's rotation smoothing effect when rotation_smoothing_enabled is true.

- zoom: Vector2 = Vector2(1, 1) [set set_zoom; get get_zoom]
