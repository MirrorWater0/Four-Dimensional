...
- Source: VisibleOnScreenEnabler2D.xml
- Inherits: VisibleOnScreenNotifier2D
- Inheritance Chain: VisibleOnScreenEnabler2D -> VisibleOnScreenNotifier2D -> Node2D -> CanvasItem -> Node -> Object
...
- enable_mode: int (VisibleOnScreenEnabler2D.EnableMode) = 0 [set set_enable_mode; get get_enable_mode]
