...
- Name: GPUParticles2D
- Source: GPUParticles2D.xml
- Inherits: Node2D
- Inheritance Chain: GPUParticles2D -> Node2D -> CanvasItem -> Node -> Object
...
- capture_rect() -> Rect2 [const]
  Returns a rectangle containing the positions of all existing particles. **Note:** When using threaded rendering this method synchronizes the rendering thread. Calling it often may have a negative impact on performance.
...
- collision_base_size: float = 1.0 [set set_collision_base_size; get get_collision_base_size]
...
- draw_order: int (GPUParticles2D.DrawOrder) = 1 [set set_draw_order; get get_draw_order]
  Particle draw order.
...
- trail_section_subdivisions: int = 4 [set set_trail_section_subdivisions; get get_trail_section_subdivisions]
...
- trail_sections: int = 8 [set set_trail_sections; get get_trail_sections]
...
- visibility_rect: Rect2 = Rect2(-100, -100, 200, 200) [set set_visibility_rect; get get_visibility_rect]
