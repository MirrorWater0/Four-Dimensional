...
- Source: MultiplayerAPIExtension.xml
- Inherits: MultiplayerAPI
- Inheritance Chain: MultiplayerAPIExtension -> MultiplayerAPI -> RefCounted -> Object
...
This class can be used to extend or replace the default MultiplayerAPI implementation via script or extensions. The following example extend the default implementation (SceneMultiplayer) by logging every RPC being made, and every object being configured for replication.
...
```
[methods]
_get_multiplayer_peer() -> MultiplayerPeer [virtual]
_get_peer_ids() -> PackedInt32Array [virtual const]
_get_remote_sender_id() -> int [virtual const]
_get_unique_id() -> int [virtual const]
_object_configuration_add(object: Object, configuration: Variant) -> int (Error) [virtual]
_object_configuration_remove(object: Object, configuration: Variant) -> int (Error) [virtual]
_poll() -> int (Error) [virtual]
_rpc(peer: int, object: Object, method: StringName, args: Array) -> int (Error) [virtual]
_set_multiplayer_peer(multiplayer_peer: MultiplayerPeer) -> void [virtual]
```
