...
- Source: MultiplayerPeerExtension.xml
- Inherits: MultiplayerPeer
- Inheritance Chain: MultiplayerPeerExtension -> MultiplayerPeer -> PacketPeer -> RefCounted -> Object
...
_disconnect_peer(p_peer: int, p_force: bool) -> void [virtual required]
_get_available_packet_count() -> int [virtual required const]
_get_connection_status() -> int (MultiplayerPeer.ConnectionStatus) [virtual required const]
...
_get_packet_channel() -> int [virtual required const]
_get_packet_mode() -> int (MultiplayerPeer.TransferMode) [virtual required const]
_get_packet_peer() -> int [virtual required const]
_get_packet_script() -> PackedByteArray [virtual]
_get_transfer_channel() -> int [virtual required const]
_get_transfer_mode() -> int (MultiplayerPeer.TransferMode) [virtual required const]
_get_unique_id() -> int [virtual required const]
_is_refusing_new_connections() -> bool [virtual const]
_is_server() -> bool [virtual required const]
_is_server_relay_supported() -> bool [virtual const]
_poll() -> void [virtual required]
_put_packet(p_buffer: const uint8_t*, p_buffer_size: int) -> int (Error) [virtual]
_put_packet_script(p_buffer: PackedByteArray) -> int (Error) [virtual]
_set_refuse_new_connections(p_enable: bool) -> void [virtual]
_set_target_peer(p_peer: int) -> void [virtual required]
_set_transfer_channel(p_channel: int) -> void [virtual required]
_set_transfer_mode(p_mode: int (MultiplayerPeer.TransferMode)) -> void [virtual required]
```
