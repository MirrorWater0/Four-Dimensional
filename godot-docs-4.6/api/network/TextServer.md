...
- Name: TextServer
- Source: TextServer.xml
- Inherits: RefCounted
- Inheritance Chain: TextServer -> RefCounted -> Object
...
create_shaped_text(direction: int (TextServer.Direction) = 0, orientation: int (TextServer.Orientation) = 0) -> RID
draw_hex_code_box(canvas: RID, size: int, pos: Vector2, index: int, color: Color) -> void [const]
...
font_draw_glyph(font_rid: RID, canvas: RID, size: int, pos: Vector2, index: int, color: Color = Color(1, 1, 1, 1), oversampling: float = 0.0) -> void [const]
font_draw_glyph_outline(font_rid: RID, canvas: RID, size: int, outline_size: int, pos: Vector2, index: int, color: Color = Color(1, 1, 1, 1), oversampling: float = 0.0) -> void [const]
font_get_antialiasing(font_rid: RID) -> int (TextServer.FontAntialiasing) [const]
font_get_ascent(font_rid: RID, size: int) -> float [const]
font_get_baseline_offset(font_rid: RID) -> float [const]
font_get_char_from_glyph_index(font_rid: RID, size: int, glyph_index: int) -> int [const]
font_get_descent(font_rid: RID, size: int) -> float [const]
font_get_disable_embedded_bitmaps(font_rid: RID) -> bool [const]
font_get_embolden(font_rid: RID) -> float [const]
font_get_face_count(font_rid: RID) -> int [const]
font_get_face_index(font_rid: RID) -> int [const]
font_get_fixed_size(font_rid: RID) -> int [const]
font_get_fixed_size_scale_mode(font_rid: RID) -> int (TextServer.FixedSizeScaleMode) [const]
font_get_generate_mipmaps(font_rid: RID) -> bool [const]
font_get_global_oversampling() -> float [const]
font_get_glyph_advance(font_rid: RID, size: int, glyph: int) -> Vector2 [const]
font_get_glyph_contours(font: RID, size: int, index: int) -> Dictionary [const]
font_get_glyph_index(font_rid: RID, size: int, char: int, variation_selector: int) -> int [const]
font_get_glyph_list(font_rid: RID, size: Vector2i) -> PackedInt32Array [const]
font_get_glyph_offset(font_rid: RID, size: Vector2i, glyph: int) -> Vector2 [const]
font_get_glyph_size(font_rid: RID, size: Vector2i, glyph: int) -> Vector2 [const]
font_get_glyph_texture_idx(font_rid: RID, size: Vector2i, glyph: int) -> int [const]
font_get_glyph_texture_rid(font_rid: RID, size: Vector2i, glyph: int) -> RID [const]
font_get_glyph_texture_size(font_rid: RID, size: Vector2i, glyph: int) -> Vector2 [const]
font_get_glyph_uv_rect(font_rid: RID, size: Vector2i, glyph: int) -> Rect2 [const]
font_get_hinting(font_rid: RID) -> int (TextServer.Hinting) [const]
font_get_keep_rounding_remainders(font_rid: RID) -> bool [const]
font_get_kerning(font_rid: RID, size: int, glyph_pair: Vector2i) -> Vector2 [const]
font_get_kerning_list(font_rid: RID, size: int) -> Vector2i[] [const]
...
font_get_msdf_pixel_range(font_rid: RID) -> int [const]
font_get_msdf_size(font_rid: RID) -> int [const]
font_get_name(font_rid: RID) -> String [const]
font_get_opentype_feature_overrides(font_rid: RID) -> Dictionary [const]
font_get_ot_name_strings(font_rid: RID) -> Dictionary [const]
font_get_oversampling(font_rid: RID) -> float [const]
font_get_scale(font_rid: RID, size: int) -> float [const]
...
font_get_size_cache_info(font_rid: RID) -> Dictionary[] [const]
font_get_size_cache_list(font_rid: RID) -> Vector2i[] [const]
font_get_spacing(font_rid: RID, spacing: int (TextServer.SpacingType)) -> int [const]
font_get_stretch(font_rid: RID) -> int [const]
font_get_style(font_rid: RID) -> int (TextServer.FontStyle) [const]
font_get_style_name(font_rid: RID) -> String [const]
font_get_subpixel_positioning(font_rid: RID) -> int (TextServer.SubpixelPositioning) [const]
font_get_supported_chars(font_rid: RID) -> String [const]
font_get_supported_glyphs(font_rid: RID) -> PackedInt32Array [const]
font_get_texture_count(font_rid: RID, size: Vector2i) -> int [const]
font_get_texture_image(font_rid: RID, size: Vector2i, texture_index: int) -> Image [const]
font_get_texture_offsets(font_rid: RID, size: Vector2i, texture_index: int) -> PackedInt32Array [const]
font_get_transform(font_rid: RID) -> Transform2D [const]
font_get_underline_position(font_rid: RID, size: int) -> float [const]
font_get_underline_thickness(font_rid: RID, size: int) -> float [const]
font_get_variation_coordinates(font_rid: RID) -> Dictionary [const]
font_get_weight(font_rid: RID) -> int [const]
font_has_char(font_rid: RID, char: int) -> bool [const]
font_is_allow_system_fallback(font_rid: RID) -> bool [const]
font_is_force_autohinter(font_rid: RID) -> bool [const]
font_is_language_supported(font_rid: RID, language: String) -> bool [const]
font_is_modulate_color_glyphs(font_rid: RID) -> bool [const]
font_is_multichannel_signed_distance_field(font_rid: RID) -> bool [const]
font_is_script_supported(font_rid: RID, script: String) -> bool [const]
...
font_set_allow_system_fallback(font_rid: RID, allow_system_fallback: bool) -> void
font_set_antialiasing(font_rid: RID, antialiasing: int (TextServer.FontAntialiasing)) -> void
...
font_set_disable_embedded_bitmaps(font_rid: RID, disable_embedded_bitmaps: bool) -> void
...
font_set_fixed_size_scale_mode(font_rid: RID, fixed_size_scale_mode: int (TextServer.FixedSizeScaleMode)) -> void
font_set_force_autohinter(font_rid: RID, force_autohinter: bool) -> void
...
font_set_hinting(font_rid: RID, hinting: int (TextServer.Hinting)) -> void
font_set_keep_rounding_remainders(font_rid: RID, keep_rounding_remainders: bool) -> void
font_set_kerning(font_rid: RID, size: int, glyph_pair: Vector2i, kerning: Vector2) -> void
font_set_language_support_override(font_rid: RID, language: String, supported: bool) -> void
font_set_modulate_color_glyphs(font_rid: RID, force_autohinter: bool) -> void
font_set_msdf_pixel_range(font_rid: RID, msdf_pixel_range: int) -> void
font_set_msdf_size(font_rid: RID, msdf_size: int) -> void
font_set_multichannel_signed_distance_field(font_rid: RID, msdf: bool) -> void
...
font_set_script_support_override(font_rid: RID, script: String, supported: bool) -> void
font_set_spacing(font_rid: RID, spacing: int (TextServer.SpacingType), value: int) -> void
font_set_stretch(font_rid: RID, weight: int) -> void
font_set_style(font_rid: RID, style: int (TextServer.FontStyle)) -> void
font_set_style_name(font_rid: RID, name: String) -> void
font_set_subpixel_positioning(font_rid: RID, subpixel_positioning: int (TextServer.SubpixelPositioning)) -> void
...
font_supported_feature_list(font_rid: RID) -> Dictionary [const]
font_supported_variation_list(font_rid: RID) -> Dictionary [const]
format_number(number: String, language: String = "") -> String [const]
free_rid(rid: RID) -> void
get_features() -> int [const]
get_hex_code_box_size(size: int, index: int) -> Vector2 [const]
get_name() -> String [const]
get_support_data() -> PackedByteArray [const]
get_support_data_filename() -> String [const]
get_support_data_info() -> String [const]
has(rid: RID) -> bool
has_feature(feature: int (TextServer.Feature)) -> bool [const]
is_confusable(string: String, dict: PackedStringArray) -> int [const]
is_locale_right_to_left(locale: String) -> bool [const]
is_locale_using_support_data(locale: String) -> bool [const]
is_valid_identifier(string: String) -> bool [const]
is_valid_letter(unicode: int) -> bool [const]
load_support_data(filename: String) -> bool
name_to_tag(name: String) -> int [const]
parse_number(number: String, language: String = "") -> String [const]
parse_structured_text(parser_type: int (TextServer.StructuredTextParser), args: Array, text: String) -> Vector3i[] [const]
percent_sign(language: String = "") -> String [const]
save_support_data(filename: String) -> bool [const]
shaped_get_run_count(shaped: RID) -> int [const]
shaped_get_run_direction(shaped: RID, index: int) -> int (TextServer.Direction) [const]
shaped_get_run_font_rid(shaped: RID, index: int) -> RID [const]
shaped_get_run_font_size(shaped: RID, index: int) -> int [const]
shaped_get_run_language(shaped: RID, index: int) -> String [const]
shaped_get_run_object(shaped: RID, index: int) -> Variant [const]
shaped_get_run_range(shaped: RID, index: int) -> Vector2i [const]
shaped_get_run_text(shaped: RID, index: int) -> String [const]
shaped_get_span_count(shaped: RID) -> int [const]
shaped_get_span_embedded_object(shaped: RID, index: int) -> Variant [const]
shaped_get_span_meta(shaped: RID, index: int) -> Variant [const]
shaped_get_span_object(shaped: RID, index: int) -> Variant [const]
shaped_get_span_text(shaped: RID, index: int) -> String [const]
shaped_get_text(shaped: RID) -> String [const]
shaped_set_span_update_font(shaped: RID, index: int, fonts: RID[], size: int, opentype_features: Dictionary = {}) -> void
shaped_text_add_object(shaped: RID, key: Variant, size: Vector2, inline_align: int (InlineAlignment) = 5, length: int = 1, baseline: float = 0.0) -> bool
...
shaped_text_closest_character_pos(shaped: RID, pos: int) -> int [const]
shaped_text_draw(shaped: RID, canvas: RID, pos: Vector2, clip_l: float = -1, clip_r: float = -1, color: Color = Color(1, 1, 1, 1), oversampling: float = 0.0) -> void [const]
shaped_text_draw_outline(shaped: RID, canvas: RID, pos: Vector2, clip_l: float = -1, clip_r: float = -1, outline_size: int = 1, color: Color = Color(1, 1, 1, 1), oversampling: float = 0.0) -> void [const]
shaped_text_duplicate(rid: RID) -> RID
shaped_text_fit_to_width(shaped: RID, width: float, justification_flags: int (TextServer.JustificationFlag) = 3) -> float
shaped_text_get_ascent(shaped: RID) -> float [const]
shaped_text_get_carets(shaped: RID, position: int) -> Dictionary [const]
shaped_text_get_character_breaks(shaped: RID) -> PackedInt32Array [const]
shaped_text_get_custom_ellipsis(shaped: RID) -> int [const]
shaped_text_get_custom_punctuation(shaped: RID) -> String [const]
shaped_text_get_descent(shaped: RID) -> float [const]
shaped_text_get_direction(shaped: RID) -> int (TextServer.Direction) [const]
shaped_text_get_dominant_direction_in_range(shaped: RID, start: int, end: int) -> int (TextServer.Direction) [const]
shaped_text_get_ellipsis_glyph_count(shaped: RID) -> int [const]
shaped_text_get_ellipsis_glyphs(shaped: RID) -> Dictionary[] [const]
shaped_text_get_ellipsis_pos(shaped: RID) -> int [const]
shaped_text_get_glyph_count(shaped: RID) -> int [const]
shaped_text_get_glyphs(shaped: RID) -> Dictionary[] [const]
shaped_text_get_grapheme_bounds(shaped: RID, pos: int) -> Vector2 [const]
shaped_text_get_inferred_direction(shaped: RID) -> int (TextServer.Direction) [const]
shaped_text_get_line_breaks(shaped: RID, width: float, start: int = 0, break_flags: int (TextServer.LineBreakFlag) = 3) -> PackedInt32Array [const]
shaped_text_get_line_breaks_adv(shaped: RID, width: PackedFloat32Array, start: int = 0, once: bool = true, break_flags: int (TextServer.LineBreakFlag) = 3) -> PackedInt32Array [const]
shaped_text_get_object_glyph(shaped: RID, key: Variant) -> int [const]
shaped_text_get_object_range(shaped: RID, key: Variant) -> Vector2i [const]
shaped_text_get_object_rect(shaped: RID, key: Variant) -> Rect2 [const]
shaped_text_get_objects(shaped: RID) -> Array [const]
shaped_text_get_orientation(shaped: RID) -> int (TextServer.Orientation) [const]
shaped_text_get_parent(shaped: RID) -> RID [const]
shaped_text_get_preserve_control(shaped: RID) -> bool [const]
shaped_text_get_preserve_invalid(shaped: RID) -> bool [const]
shaped_text_get_range(shaped: RID) -> Vector2i [const]
shaped_text_get_selection(shaped: RID, start: int, end: int) -> PackedVector2Array [const]
shaped_text_get_size(shaped: RID) -> Vector2 [const]
shaped_text_get_spacing(shaped: RID, spacing: int (TextServer.SpacingType)) -> int [const]
shaped_text_get_trim_pos(shaped: RID) -> int [const]
shaped_text_get_underline_position(shaped: RID) -> float [const]
shaped_text_get_underline_thickness(shaped: RID) -> float [const]
shaped_text_get_width(shaped: RID) -> float [const]
shaped_text_get_word_breaks(shaped: RID, grapheme_flags: int (TextServer.GraphemeFlag) = 264, skip_grapheme_flags: int (TextServer.GraphemeFlag) = 4) -> PackedInt32Array [const]
shaped_text_has_object(shaped: RID, key: Variant) -> bool [const]
shaped_text_has_visible_chars(shaped: RID) -> bool [const]
shaped_text_hit_test_grapheme(shaped: RID, coords: float) -> int [const]
shaped_text_hit_test_position(shaped: RID, coords: float) -> int [const]
shaped_text_is_ready(shaped: RID) -> bool [const]
shaped_text_next_character_pos(shaped: RID, pos: int) -> int [const]
shaped_text_next_grapheme_pos(shaped: RID, pos: int) -> int [const]
shaped_text_overrun_trim_to_width(shaped: RID, width: float = 0, overrun_trim_flags: int (TextServer.TextOverrunFlag) = 0) -> void
shaped_text_prev_character_pos(shaped: RID, pos: int) -> int [const]
shaped_text_prev_grapheme_pos(shaped: RID, pos: int) -> int [const]
shaped_text_resize_object(shaped: RID, key: Variant, size: Vector2, inline_align: int (InlineAlignment) = 5, baseline: float = 0.0) -> bool
...
shaped_text_set_direction(shaped: RID, direction: int (TextServer.Direction) = 0) -> void
shaped_text_set_orientation(shaped: RID, orientation: int (TextServer.Orientation) = 0) -> void
shaped_text_set_preserve_control(shaped: RID, enabled: bool) -> void
shaped_text_set_preserve_invalid(shaped: RID, enabled: bool) -> void
shaped_text_set_spacing(shaped: RID, spacing: int (TextServer.SpacingType), value: int) -> void
shaped_text_shape(shaped: RID) -> bool
shaped_text_sort_logical(shaped: RID) -> Dictionary[]
shaped_text_substr(shaped: RID, start: int, length: int) -> RID [const]
shaped_text_tab_align(shaped: RID, tab_stops: PackedFloat32Array) -> float
spoof_check(string: String) -> bool [const]
string_get_character_breaks(string: String, language: String = "") -> PackedInt32Array [const]
string_get_word_breaks(string: String, language: String = "", chars_per_line: int = 0) -> PackedInt32Array [const]
string_to_lower(string: String, language: String = "") -> String [const]
string_to_title(string: String, language: String = "") -> String [const]
string_to_upper(string: String, language: String = "") -> String [const]
strip_diacritics(string: String) -> String [const]
tag_to_name(tag: int) -> String [const]
```
...
- create_shaped_text(direction: int (TextServer.Direction) = 0, orientation: int (TextServer.Orientation) = 0) -> RID
  Creates a new buffer for complex text layout, with the given direction and orientation. To free the resulting buffer, use free_rid() method. **Note:** Direction is ignored if server does not support FEATURE_BIDI_LAYOUT feature (supported by TextServerAdvanced). **Note:** Orientation is ignored if server does not support FEATURE_VERTICAL_LAYOUT feature (supported by TextServerAdvanced).
...
- font_set_stretch(font_rid: RID, weight: int) -> void
  Sets font stretch amount, compared to a normal width. A percentage value between 50% and 200%. **Note:** This value is used for font matching only and will not affect font rendering. Use font_set_face_index(), font_set_variation_coordinates(), or font_set_transform() instead.

- font_set_style(font_rid: RID, style: int (TextServer.FontStyle)) -> void
  Sets the font style flags. **Note:** This value is used for font matching only and will not affect font rendering. Use font_set_face_index(), font_set_variation_coordinates(), font_set_embolden(), or font_set_transform() instead.
...
- font_set_weight(font_rid: RID, weight: int) -> void
  Sets weight (boldness) of the font. A value in the 100...999 range, normal font weight is 400, bold font weight is 700. **Note:** This value is used for font matching only and will not affect font rendering. Use font_set_face_index(), font_set_variation_coordinates(), or font_set_embolden() instead.
...
- percent_sign(language: String = "") -> String [const]
  Returns the percent sign used in the given language. If language is an empty string, the active locale will be used.
...
- shaped_text_set_orientation(shaped: RID, orientation: int (TextServer.Orientation) = 0) -> void
  Sets desired text orientation. **Note:** Orientation is ignored if server does not support FEATURE_VERTICAL_LAYOUT feature (supported by TextServerAdvanced).
...
- string_to_lower(string: String, language: String = "") -> String [const]
  Returns the string converted to lowercase. **Note:** Casing is locale dependent and context sensitive if server support FEATURE_CONTEXT_SENSITIVE_CASE_CONVERSION feature (supported by TextServerAdvanced). **Note:** The result may be longer or shorter than the original.

- string_to_title(string: String, language: String = "") -> String [const]
  Returns the string converted to Title Case. **Note:** Casing is locale dependent and context sensitive if server support FEATURE_CONTEXT_SENSITIVE_CASE_CONVERSION feature (supported by TextServerAdvanced). **Note:** The result may be longer or shorter than the original.

- string_to_upper(string: String, language: String = "") -> String [const]
  Returns the string converted to UPPERCASE. **Note:** Casing is locale dependent and context sensitive if server support FEATURE_CONTEXT_SENSITIVE_CASE_CONVERSION feature (supported by TextServerAdvanced). **Note:** The result may be longer or shorter than the original.
...
- JUSTIFICATION_NONE = 0 [bitfield]
  Do not justify text.

- JUSTIFICATION_KASHIDA = 1 [bitfield]
  Justify text by adding and removing kashidas.

- JUSTIFICATION_WORD_BOUND = 2 [bitfield]
  Justify text by changing width of the spaces between the words.

- JUSTIFICATION_TRIM_EDGE_SPACES = 4 [bitfield]
  Remove trailing and leading spaces from the justified text.

- JUSTIFICATION_AFTER_LAST_TAB = 8 [bitfield]
  Only apply justification to the part of the text after the last tab.

- JUSTIFICATION_CONSTRAIN_ELLIPSIS = 16 [bitfield]
  Apply justification to the trimmed line with ellipsis.

- JUSTIFICATION_SKIP_LAST_LINE = 32 [bitfield]
  Do not apply justification to the last line of the paragraph.

- JUSTIFICATION_SKIP_LAST_LINE_WITH_VISIBLE_CHARS = 64 [bitfield]
...
- JUSTIFICATION_DO_NOT_SKIP_SINGLE_LINE = 128 [bitfield]
...
- BREAK_NONE = 0 [bitfield]
  Do not break the line.

- BREAK_MANDATORY = 1 [bitfield]
  Break the line at the line mandatory break characters (e.g. "\n").

- BREAK_WORD_BOUND = 2 [bitfield]
  Break the line between the words.

- BREAK_GRAPHEME_BOUND = 4 [bitfield]
  Break the line between any unconnected graphemes.

- BREAK_ADAPTIVE = 8 [bitfield]
...
- BREAK_TRIM_EDGE_SPACES = 16 [bitfield]
  Remove edge spaces from the broken line segments.

- BREAK_TRIM_INDENT = 32 [bitfield]
  Subtract first line indentation width from all lines after the first one.

- BREAK_TRIM_START_EDGE_SPACES = 64 [bitfield]
...
- BREAK_TRIM_END_EDGE_SPACES = 128 [bitfield]
...
- OVERRUN_NO_TRIM = 0 [bitfield]
  No trimming is performed.

- OVERRUN_TRIM = 1 [bitfield]
  Trims the text when it exceeds the given width.

- OVERRUN_TRIM_WORD_ONLY = 2 [bitfield]
  Trims the text per word instead of per grapheme.

- OVERRUN_ADD_ELLIPSIS = 4 [bitfield]
  Determines whether an ellipsis should be added at the end of the text.

- OVERRUN_ENFORCE_ELLIPSIS = 8 [bitfield]
  Determines whether the ellipsis at the end of the text is enforced and may not be hidden.

- OVERRUN_JUSTIFICATION_AWARE = 16 [bitfield]
  Accounts for the text being justified before attempting to trim it (see JustificationFlag).

- OVERRUN_SHORT_STRING_ELLIPSIS = 32 [bitfield]
...
- GRAPHEME_IS_VALID = 1 [bitfield]
  Grapheme is supported by the font, and can be drawn.

- GRAPHEME_IS_RTL = 2 [bitfield]
  Grapheme is part of right-to-left or bottom-to-top run.

- GRAPHEME_IS_VIRTUAL = 4 [bitfield]
  Grapheme is not part of source text, it was added by justification process.

- GRAPHEME_IS_SPACE = 8 [bitfield]
  Grapheme is whitespace.

- GRAPHEME_IS_BREAK_HARD = 16 [bitfield]
  Grapheme is mandatory break point (e.g. "\n").

- GRAPHEME_IS_BREAK_SOFT = 32 [bitfield]
  Grapheme is optional break point (e.g. space).

- GRAPHEME_IS_TAB = 64 [bitfield]
  Grapheme is the tabulation character.

- GRAPHEME_IS_ELONGATION = 128 [bitfield]
  Grapheme is kashida.

- GRAPHEME_IS_PUNCTUATION = 256 [bitfield]
  Grapheme is punctuation character.

- GRAPHEME_IS_UNDERSCORE = 512 [bitfield]
  Grapheme is underscore character.

- GRAPHEME_IS_CONNECTED = 1024 [bitfield]
  Grapheme is connected to the previous grapheme. Breaking line before this grapheme is not safe.

- GRAPHEME_IS_SAFE_TO_INSERT_TATWEEL = 2048 [bitfield]
  It is safe to insert a U+0640 before this grapheme for elongation.

- GRAPHEME_IS_EMBEDDED_OBJECT = 4096 [bitfield]
  Grapheme is an object replacement character for the embedded object.

- GRAPHEME_IS_SOFT_HYPHEN = 8192 [bitfield]
...
- FONT_BOLD = 1 [bitfield]
  Font is bold.

- FONT_ITALIC = 2 [bitfield]
  Font is italic or oblique.

- FONT_FIXED_WIDTH = 4 [bitfield]
