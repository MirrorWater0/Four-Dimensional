...
- Name: PacketPeerDTLS
- Source: PacketPeerDTLS.xml
- Inherits: PacketPeer
- Inheritance Chain: PacketPeerDTLS -> PacketPeer -> RefCounted -> Object
...
```
[methods]
connect_to_peer(packet_peer: PacketPeerUDP, hostname: String, client_options: TLSOptions = null) -> int (Error)
disconnect_from_peer() -> void
get_status() -> int (PacketPeerDTLS.Status) [const]
poll() -> void
```
