...
- Name: StreamPeerTLS
- Source: StreamPeerTLS.xml
- Inherits: StreamPeer
- Inheritance Chain: StreamPeerTLS -> StreamPeer -> RefCounted -> Object
...
```
[methods]
accept_stream(stream: StreamPeer, server_options: TLSOptions) -> int (Error)
connect_to_stream(stream: StreamPeer, common_name: String, client_options: TLSOptions = null) -> int (Error)
disconnect_from_stream() -> void
get_status() -> int (StreamPeerTLS.Status) [const]
get_stream() -> StreamPeer [const]
poll() -> void
```
