...
- Name: UDPServer
- Source: UDPServer.xml
- Inherits: RefCounted
- Inheritance Chain: UDPServer -> RefCounted -> Object
...
- max_pending_connections: int = 16 [set set_max_pending_connections; get get_max_pending_connections]
