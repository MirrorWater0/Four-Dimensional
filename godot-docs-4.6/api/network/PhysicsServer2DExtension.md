...
- Source: PhysicsServer2DExtension.xml
- Inherits: PhysicsServer2D
- Inheritance Chain: PhysicsServer2DExtension -> PhysicsServer2D -> Object
...
```
[methods]
_area_add_shape(area: RID, shape: RID, transform: Transform2D, disabled: bool) -> void [virtual required]
_area_attach_canvas_instance_id(area: RID, id: int) -> void [virtual required]
...
_area_get_canvas_instance_id(area: RID) -> int [virtual required const]
...
_area_get_param(area: RID, param: int (PhysicsServer2D.AreaParameter)) -> Variant [virtual required const]
...
_area_get_shape_transform(area: RID, shape_idx: int) -> Transform2D [virtual required const]
_area_get_space(area: RID) -> RID [virtual required const]
_area_get_transform(area: RID) -> Transform2D [virtual required const]
...
_area_set_param(area: RID, param: int (PhysicsServer2D.AreaParameter), value: Variant) -> void [virtual required]
_area_set_pickable(area: RID, pickable: bool) -> void [virtual required]
...
_area_set_shape_transform(area: RID, shape_idx: int, transform: Transform2D) -> void [virtual required]
_area_set_space(area: RID, space: RID) -> void [virtual required]
_area_set_transform(area: RID, transform: Transform2D) -> void [virtual required]
_body_add_collision_exception(body: RID, excepted_body: RID) -> void [virtual required]
_body_add_constant_central_force(body: RID, force: Vector2) -> void [virtual required]
_body_add_constant_force(body: RID, force: Vector2, position: Vector2) -> void [virtual required]
_body_add_constant_torque(body: RID, torque: float) -> void [virtual required]
_body_add_shape(body: RID, shape: RID, transform: Transform2D, disabled: bool) -> void [virtual required]
_body_apply_central_force(body: RID, force: Vector2) -> void [virtual required]
_body_apply_central_impulse(body: RID, impulse: Vector2) -> void [virtual required]
_body_apply_force(body: RID, force: Vector2, position: Vector2) -> void [virtual required]
_body_apply_impulse(body: RID, impulse: Vector2, position: Vector2) -> void [virtual required]
_body_apply_torque(body: RID, torque: float) -> void [virtual required]
_body_apply_torque_impulse(body: RID, impulse: float) -> void [virtual required]
_body_attach_canvas_instance_id(body: RID, id: int) -> void [virtual required]
_body_attach_object_instance_id(body: RID, id: int) -> void [virtual required]
_body_clear_shapes(body: RID) -> void [virtual required]
_body_collide_shape(body: RID, body_shape: int, shape: RID, shape_xform: Transform2D, motion: Vector2, results: void*, result_max: int, result_count: int32_t*) -> bool [virtual required]
_body_create() -> RID [virtual required]
_body_get_canvas_instance_id(body: RID) -> int [virtual required const]
...
_body_get_constant_force(body: RID) -> Vector2 [virtual required const]
_body_get_constant_torque(body: RID) -> float [virtual required const]
_body_get_contacts_reported_depth_threshold(body: RID) -> float [virtual required const]
_body_get_continuous_collision_detection_mode(body: RID) -> int (PhysicsServer2D.CCDMode) [virtual required const]
_body_get_direct_state(body: RID) -> PhysicsDirectBodyState2D [virtual required]
_body_get_max_contacts_reported(body: RID) -> int [virtual required const]
_body_get_mode(body: RID) -> int (PhysicsServer2D.BodyMode) [virtual required const]
_body_get_object_instance_id(body: RID) -> int [virtual required const]
_body_get_param(body: RID, param: int (PhysicsServer2D.BodyParameter)) -> Variant [virtual required const]
...
_body_get_shape_transform(body: RID, shape_idx: int) -> Transform2D [virtual required const]
_body_get_space(body: RID) -> RID [virtual required const]
_body_get_state(body: RID, state: int (PhysicsServer2D.BodyState)) -> Variant [virtual required const]
...
_body_set_axis_velocity(body: RID, axis_velocity: Vector2) -> void [virtual required]
...
_body_set_constant_force(body: RID, force: Vector2) -> void [virtual required]
_body_set_constant_torque(body: RID, torque: float) -> void [virtual required]
_body_set_contacts_reported_depth_threshold(body: RID, threshold: float) -> void [virtual required]
_body_set_continuous_collision_detection_mode(body: RID, mode: int (PhysicsServer2D.CCDMode)) -> void [virtual required]
...
_body_set_mode(body: RID, mode: int (PhysicsServer2D.BodyMode)) -> void [virtual required]
_body_set_omit_force_integration(body: RID, enable: bool) -> void [virtual required]
_body_set_param(body: RID, param: int (PhysicsServer2D.BodyParameter), value: Variant) -> void [virtual required]
_body_set_pickable(body: RID, pickable: bool) -> void [virtual required]
_body_set_shape(body: RID, shape_idx: int, shape: RID) -> void [virtual required]
_body_set_shape_as_one_way_collision(body: RID, shape_idx: int, enable: bool, margin: float) -> void [virtual required]
_body_set_shape_disabled(body: RID, shape_idx: int, disabled: bool) -> void [virtual required]
_body_set_shape_transform(body: RID, shape_idx: int, transform: Transform2D) -> void [virtual required]
_body_set_space(body: RID, space: RID) -> void [virtual required]
_body_set_state(body: RID, state: int (PhysicsServer2D.BodyState), value: Variant) -> void [virtual required]
_body_set_state_sync_callback(body: RID, callable: Callable) -> void [virtual required]
_body_test_motion(body: RID, from: Transform2D, motion: Vector2, margin: float, collide_separation_ray: bool, recovery_as_collision: bool, result: PhysicsServer2DExtensionMotionResult*) -> bool [virtual required const]
_capsule_shape_create() -> RID [virtual required]
_circle_shape_create() -> RID [virtual required]
_concave_polygon_shape_create() -> RID [virtual required]
_convex_polygon_shape_create() -> RID [virtual required]
_damped_spring_joint_get_param(joint: RID, param: int (PhysicsServer2D.DampedSpringParam)) -> float [virtual required const]
_damped_spring_joint_set_param(joint: RID, param: int (PhysicsServer2D.DampedSpringParam), value: float) -> void [virtual required]
...
_get_process_info(process_info: int (PhysicsServer2D.ProcessInfo)) -> int [virtual required]
...
_joint_get_param(joint: RID, param: int (PhysicsServer2D.JointParam)) -> float [virtual required const]
_joint_get_type(joint: RID) -> int (PhysicsServer2D.JointType) [virtual required const]
_joint_is_disabled_collisions_between_bodies(joint: RID) -> bool [virtual required const]
_joint_make_damped_spring(joint: RID, anchor_a: Vector2, anchor_b: Vector2, body_a: RID, body_b: RID) -> void [virtual required]
_joint_make_groove(joint: RID, a_groove1: Vector2, a_groove2: Vector2, b_anchor: Vector2, body_a: RID, body_b: RID) -> void [virtual required]
_joint_make_pin(joint: RID, anchor: Vector2, body_a: RID, body_b: RID) -> void [virtual required]
_joint_set_param(joint: RID, param: int (PhysicsServer2D.JointParam), value: float) -> void [virtual required]
_pin_joint_get_flag(joint: RID, flag: int (PhysicsServer2D.PinJointFlag)) -> bool [virtual required const]
_pin_joint_get_param(joint: RID, param: int (PhysicsServer2D.PinJointParam)) -> float [virtual required const]
_pin_joint_set_flag(joint: RID, flag: int (PhysicsServer2D.PinJointFlag), enabled: bool) -> void [virtual required]
_pin_joint_set_param(joint: RID, param: int (PhysicsServer2D.PinJointParam), value: float) -> void [virtual required]
_rectangle_shape_create() -> RID [virtual required]
_segment_shape_create() -> RID [virtual required]
_separation_ray_shape_create() -> RID [virtual required]
_set_active(active: bool) -> void [virtual required]
_shape_collide(shape_A: RID, xform_A: Transform2D, motion_A: Vector2, shape_B: RID, xform_B: Transform2D, motion_B: Vector2, results: void*, result_max: int, result_count: int32_t*) -> bool [virtual required]
...
_shape_get_type(shape: RID) -> int (PhysicsServer2D.ShapeType) [virtual required const]
...
_space_get_contacts(space: RID) -> PackedVector2Array [virtual required const]
_space_get_direct_state(space: RID) -> PhysicsDirectSpaceState2D [virtual required]
_space_get_param(space: RID, param: int (PhysicsServer2D.SpaceParameter)) -> float [virtual required const]
...
_space_set_param(space: RID, param: int (PhysicsServer2D.SpaceParameter), value: float) -> void [virtual required]
...
- _body_get_collision_exceptions(body: RID) -> RID[] [virtual required const]
  Returns the RIDs of all bodies added as collision exceptions for the given body. See also _body_add_collision_exception() and _body_remove_collision_exception(). Overridable version of PhysicsServer2D's internal body_get_collision_exceptions method. Corresponds to PhysicsBody2D.get_collision_exceptions().
...
- _body_get_contacts_reported_depth_threshold(body: RID) -> float [virtual required const]
  Overridable version of PhysicsServer2D's internal body_get_contacts_reported_depth_threshold method. **Note:** This method is currently unused by Godot's default physics implementation.
...
- _body_set_contacts_reported_depth_threshold(body: RID, threshold: float) -> void [virtual required]
  Overridable version of PhysicsServer2D's internal body_set_contacts_reported_depth_threshold method. **Note:** This method is currently unused by Godot's default physics implementation.
...
- _body_set_state_sync_callback(body: RID, callable: Callable) -> void [virtual required]
  Assigns the body to call the given callable during the synchronization phase of the loop, before _step() is called. See also _sync(). Overridable version of PhysicsServer2D.body_set_state_sync_callback().
...
- _finish() -> void [virtual required]
  Called when the main loop finalizes to shut down the physics server. See also MainLoop._finalize() and _init(). Overridable version of PhysicsServer2D's internal finish method.
...
- _shape_collide(shape_A: RID, xform_A: Transform2D, motion_A: Vector2, shape_B: RID, xform_B: Transform2D, motion_B: Vector2, results: void*, result_max: int, result_count: int32_t*) -> bool [virtual required]
  Given two shapes and their parameters, should return true if a collision between the two would occur, with additional details passed in results. Overridable version of PhysicsServer2D's internal shape_collide method. Corresponds to PhysicsDirectSpaceState2D.collide_shape().
...
- _space_get_contact_count(space: RID) -> int [virtual required const]
  Should return how many contacts have occurred during the last physics step in the given space. See also _space_get_contacts() and _space_set_debug_contacts(). Overridable version of PhysicsServer2D's internal space_get_contact_count method.

- _space_get_contacts(space: RID) -> PackedVector2Array [virtual required const]
  Should return the positions of all contacts that have occurred during the last physics step in the given space. See also _space_get_contact_count() and _space_set_debug_contacts(). Overridable version of PhysicsServer2D's internal space_get_contacts method.
