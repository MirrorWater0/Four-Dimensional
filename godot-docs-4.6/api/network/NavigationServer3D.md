...
- Source: NavigationServer3D.xml
- Inherits: Object
- Inheritance Chain: NavigationServer3D -> Object
...
agent_get_height(agent: RID) -> float [const]
...
agent_get_position(agent: RID) -> Vector3 [const]
...
agent_get_use_3d_avoidance(agent: RID) -> bool [const]
agent_get_velocity(agent: RID) -> Vector3 [const]
...
agent_set_use_3d_avoidance(agent: RID, enabled: bool) -> void
agent_set_velocity(agent: RID, velocity: Vector3) -> void
agent_set_velocity_forced(agent: RID, velocity: Vector3) -> void
bake_from_source_geometry_data(navigation_mesh: NavigationMesh, source_geometry_data: NavigationMeshSourceGeometryData3D, callback: Callable = Callable()) -> void
bake_from_source_geometry_data_async(navigation_mesh: NavigationMesh, source_geometry_data: NavigationMeshSourceGeometryData3D, callback: Callable = Callable()) -> void
free_rid(rid: RID) -> void
get_debug_enabled() -> bool [const]
get_maps() -> RID[] [const]
get_process_info(process_info: int (NavigationServer3D.ProcessInfo)) -> int [const]
is_baking_navigation_mesh(navigation_mesh: NavigationMesh) -> bool [const]
link_create() -> RID
link_get_enabled(link: RID) -> bool [const]
link_get_end_position(link: RID) -> Vector3 [const]
...
link_get_start_position(link: RID) -> Vector3 [const]
...
map_get_cell_height(map: RID) -> float [const]
map_get_cell_size(map: RID) -> float [const]
map_get_closest_point(map: RID, to_point: Vector3) -> Vector3 [const]
map_get_closest_point_normal(map: RID, to_point: Vector3) -> Vector3 [const]
map_get_closest_point_owner(map: RID, to_point: Vector3) -> RID [const]
map_get_closest_point_to_segment(map: RID, start: Vector3, end: Vector3, use_collision: bool = false) -> Vector3 [const]
...
map_get_random_point(map: RID, navigation_layers: int, uniformly: bool) -> Vector3 [const]
map_get_regions(map: RID) -> RID[] [const]
map_get_up(map: RID) -> Vector3 [const]
...
obstacle_get_height(obstacle: RID) -> float [const]
obstacle_get_map(obstacle: RID) -> RID [const]
obstacle_get_paused(obstacle: RID) -> bool [const]
obstacle_get_position(obstacle: RID) -> Vector3 [const]
obstacle_get_radius(obstacle: RID) -> float [const]
obstacle_get_use_3d_avoidance(obstacle: RID) -> bool [const]
obstacle_get_velocity(obstacle: RID) -> Vector3 [const]
obstacle_get_vertices(obstacle: RID) -> PackedVector3Array [const]
...
obstacle_set_use_3d_avoidance(obstacle: RID, enabled: bool) -> void
...
parse_source_geometry_data(navigation_mesh: NavigationMesh, source_geometry_data: NavigationMeshSourceGeometryData3D, root_node: Node, callback: Callable = Callable()) -> void
query_path(parameters: NavigationPathQueryParameters3D, result: NavigationPathQueryResult3D, callback: Callable = Callable()) -> void
region_bake_navigation_mesh(navigation_mesh: NavigationMesh, root_node: Node) -> void
region_create() -> RID
region_get_bounds(region: RID) -> AABB [const]
region_get_closest_point(region: RID, to_point: Vector3) -> Vector3 [const]
region_get_closest_point_normal(region: RID, to_point: Vector3) -> Vector3 [const]
region_get_closest_point_to_segment(region: RID, start: Vector3, end: Vector3, use_collision: bool = false) -> Vector3 [const]
region_get_connection_pathway_end(region: RID, connection: int) -> Vector3 [const]
region_get_connection_pathway_start(region: RID, connection: int) -> Vector3 [const]
...
region_get_random_point(region: RID, navigation_layers: int, uniformly: bool) -> Vector3 [const]
region_get_transform(region: RID) -> Transform3D [const]
...
region_owns_point(region: RID, point: Vector3) -> bool [const]
...
- map_get_closest_point_to_segment(map: RID, start: Vector3, end: Vector3, use_collision: bool = false) -> Vector3 [const]
  Returns the navigation mesh surface point closest to the provided start and end segment on the navigation map. If use_collision is true, a closest point test is only done when the segment intersects with the navigation mesh surface.
...
- region_get_closest_point_to_segment(region: RID, start: Vector3, end: Vector3, use_collision: bool = false) -> Vector3 [const]
  Returns the navigation mesh surface point closest to the provided start and end segment on the navigation region. If use_collision is true, a closest point test is only done when the segment intersects with the navigation mesh surface.
