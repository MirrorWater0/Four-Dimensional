...
- Source: NavigationMeshSourceGeometryData3D.xml
- Inherits: Resource
- Inheritance Chain: NavigationMeshSourceGeometryData3D -> Resource -> RefCounted -> Object
...
add_projected_obstruction(vertices: PackedVector3Array, elevation: float, height: float, carve: bool) -> void
...
get_vertices() -> PackedFloat32Array [const]
has_data() -> bool
...
- set_indices(indices: PackedInt32Array) -> void
  Sets the parsed source geometry data indices. The indices need to be matched with appropriated vertices. **Warning:** Inappropriate data can crash the baking process of the involved third-party libraries.
...
- set_vertices(vertices: PackedFloat32Array) -> void
  Sets the parsed source geometry data vertices. The vertices need to be matched with appropriated indices. **Warning:** Inappropriate data can crash the baking process of the involved third-party libraries.
