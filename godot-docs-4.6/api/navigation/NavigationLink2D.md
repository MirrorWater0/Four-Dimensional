...
- Source: NavigationLink2D.xml
- Inherits: Node2D
- Inheritance Chain: NavigationLink2D -> Node2D -> CanvasItem -> Node -> Object
...
```
[methods]
get_global_end_position() -> Vector2 [const]
get_global_start_position() -> Vector2 [const]
...
- bidirectional: bool = true [set set_bidirectional; get is_bidirectional]
...
- end_position: Vector2 = Vector2(0, 0) [set set_end_position; get get_end_position]
...
- enter_cost: float = 0.0 [set set_enter_cost; get get_enter_cost]
...
- travel_cost: float = 1.0 [set set_travel_cost; get get_travel_cost]
