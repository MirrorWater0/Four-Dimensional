...
- Source: NavigationLink3D.xml
- Inherits: Node3D
- Inheritance Chain: NavigationLink3D -> Node3D -> Node -> Object
...
```
[methods]
get_global_end_position() -> Vector3 [const]
get_global_start_position() -> Vector3 [const]
...
- end_position: Vector3 = Vector3(0, 0, 0) [set set_end_position; get get_end_position]
