...
- Source: NavigationAgent3D.xml
- Inherits: Node
- Inheritance Chain: NavigationAgent3D -> Node -> Object
...
get_current_navigation_path() -> PackedVector3Array [const]
get_current_navigation_path_index() -> int [const]
get_current_navigation_result() -> NavigationPathQueryResult3D [const]
...
- keep_y_velocity: bool = true [set set_keep_y_velocity; get get_keep_y_velocity]
...
- max_speed: float = 10.0 [set set_max_speed; get get_max_speed]
...
- neighbor_distance: float = 50.0 [set set_neighbor_distance; get get_neighbor_distance]
  The distance to search for other agents.

- path_desired_distance: float = 1.0 [set set_path_desired_distance; get get_path_desired_distance]
...
- path_height_offset: float = 0.0 [set set_path_height_offset; get get_path_height_offset]
...
- path_max_distance: float = 5.0 [set set_path_max_distance; get get_path_max_distance]
  The maximum distance the agent is allowed away from the ideal path to the final position. This can happen due to trying to avoid collisions. When the maximum distance is exceeded, it recalculates the ideal path.

- path_metadata_flags: int (NavigationPathQueryParameters3D.PathMetadataFlags) = 7 [set set_path_metadata_flags; get get_path_metadata_flags]
  Additional information to return with the navigation path.

- path_postprocessing: int (NavigationPathQueryParameters3D.PathPostProcessing) = 0 [set set_path_postprocessing; get get_path_postprocessing]
...
- pathfinding_algorithm: int (NavigationPathQueryParameters3D.PathfindingAlgorithm) = 0 [set set_pathfinding_algorithm; get get_pathfinding_algorithm]
...
- target_desired_distance: float = 1.0 [set set_target_desired_distance; get get_target_desired_distance]
...
- target_position: Vector3 = Vector3(0, 0, 0) [set set_target_position; get get_target_position]
...
- use_3d_avoidance: bool = false [set set_use_3d_avoidance; get get_use_3d_avoidance]
...
- velocity: Vector3 = Vector3(0, 0, 0) [set set_velocity; get get_velocity]
