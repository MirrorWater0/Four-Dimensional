...
- Source: NavigationRegion2D.xml
- Inherits: Node2D
- Inheritance Chain: NavigationRegion2D -> Node2D -> CanvasItem -> Node -> Object
...
- navigation_polygon: NavigationPolygon [set set_navigation_polygon; get get_navigation_polygon]
...
- use_edge_connections: bool = true [set set_use_edge_connections; get get_use_edge_connections]
