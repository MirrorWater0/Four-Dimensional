...
- Source: NavigationRegion3D.xml
- Inherits: Node3D
- Inheritance Chain: NavigationRegion3D -> Node3D -> Node -> Object
...
```
[methods]
bake_navigation_mesh(on_thread: bool = true) -> void
...
- navigation_mesh: NavigationMesh [set set_navigation_mesh; get get_navigation_mesh]
