...
- Source: EditorScenePostImportPlugin.xml
- Inherits: RefCounted
- Inheritance Chain: EditorScenePostImportPlugin -> RefCounted -> Object
...
_get_internal_import_options(category: int) -> void [virtual]
_get_internal_option_update_view_required(category: int, option: String) -> Variant [virtual const]
_get_internal_option_visibility(category: int, for_animation: bool, option: String) -> Variant [virtual const]
_get_option_visibility(path: String, for_animation: bool, option: String) -> Variant [virtual const]
_internal_process(category: int, base_node: Node, node: Node, resource: Resource) -> void [virtual]
_post_process(scene: Node) -> void [virtual]
_pre_process(scene: Node) -> void [virtual]
...
get_option_value(name: StringName) -> Variant [const]
```
