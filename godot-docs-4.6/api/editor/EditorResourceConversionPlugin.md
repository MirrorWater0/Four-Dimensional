...
- Source: EditorResourceConversionPlugin.xml
- Inherits: RefCounted
- Inheritance Chain: EditorResourceConversionPlugin -> RefCounted -> Object
...
```
[methods]
_convert(resource: Resource) -> Resource [virtual const]
_converts_to() -> String [virtual const]
_handles(resource: Resource) -> bool [virtual const]
```
