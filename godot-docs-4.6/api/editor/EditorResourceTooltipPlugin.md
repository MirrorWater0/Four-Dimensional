...
- Source: EditorResourceTooltipPlugin.xml
- Inherits: RefCounted
- Inheritance Chain: EditorResourceTooltipPlugin -> RefCounted -> Object
...
```
[methods]
_handles(type: String) -> bool [virtual const]
_make_tooltip_for_path(path: String, metadata: Dictionary, base: Control) -> Control [virtual const]
request_thumbnail(path: String, control: TextureRect) -> void [const]
```
