...
- Source: ResourceImporterOBJ.xml
- Inherits: ResourceImporter
- Inheritance Chain: ResourceImporterOBJ -> ResourceImporter -> RefCounted -> Object
...
- generate_lightmap_uv2_texel_size: float = 0.2
  Controls the size of each texel on the baked lightmap. A smaller value results in more precise lightmaps, at the cost of larger lightmap sizes and longer bake times. **Note:** Only effective if generate_lightmap_uv2 is true.
