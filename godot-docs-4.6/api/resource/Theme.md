...
- Source: Theme.xml
- Inherits: Resource
- Inheritance Chain: Theme -> Resource -> RefCounted -> Object
...
clear_theme_item(data_type: int (Theme.DataType), name: StringName, theme_type: StringName) -> void
clear_type_variation(theme_type: StringName) -> void
get_color(name: StringName, theme_type: StringName) -> Color [const]
get_color_list(theme_type: String) -> PackedStringArray [const]
get_color_type_list() -> PackedStringArray [const]
get_constant(name: StringName, theme_type: StringName) -> int [const]
get_constant_list(theme_type: String) -> PackedStringArray [const]
get_constant_type_list() -> PackedStringArray [const]
get_font(name: StringName, theme_type: StringName) -> Font [const]
get_font_list(theme_type: String) -> PackedStringArray [const]
get_font_size(name: StringName, theme_type: StringName) -> int [const]
get_font_size_list(theme_type: String) -> PackedStringArray [const]
get_font_size_type_list() -> PackedStringArray [const]
get_font_type_list() -> PackedStringArray [const]
get_icon(name: StringName, theme_type: StringName) -> Texture2D [const]
get_icon_list(theme_type: String) -> PackedStringArray [const]
get_icon_type_list() -> PackedStringArray [const]
get_stylebox(name: StringName, theme_type: StringName) -> StyleBox [const]
get_stylebox_list(theme_type: String) -> PackedStringArray [const]
get_stylebox_type_list() -> PackedStringArray [const]
get_theme_item(data_type: int (Theme.DataType), name: StringName, theme_type: StringName) -> Variant [const]
get_theme_item_list(data_type: int (Theme.DataType), theme_type: String) -> PackedStringArray [const]
get_theme_item_type_list(data_type: int (Theme.DataType)) -> PackedStringArray [const]
get_type_list() -> PackedStringArray [const]
get_type_variation_base(theme_type: StringName) -> StringName [const]
get_type_variation_list(base_type: StringName) -> PackedStringArray [const]
has_color(name: StringName, theme_type: StringName) -> bool [const]
has_constant(name: StringName, theme_type: StringName) -> bool [const]
has_default_base_scale() -> bool [const]
has_default_font() -> bool [const]
has_default_font_size() -> bool [const]
has_font(name: StringName, theme_type: StringName) -> bool [const]
has_font_size(name: StringName, theme_type: StringName) -> bool [const]
has_icon(name: StringName, theme_type: StringName) -> bool [const]
has_stylebox(name: StringName, theme_type: StringName) -> bool [const]
has_theme_item(data_type: int (Theme.DataType), name: StringName, theme_type: StringName) -> bool [const]
is_type_variation(theme_type: StringName, base_type: StringName) -> bool [const]
...
rename_theme_item(data_type: int (Theme.DataType), old_name: StringName, name: StringName, theme_type: StringName) -> void
...
set_theme_item(data_type: int (Theme.DataType), name: StringName, theme_type: StringName, value: Variant) -> void
...
- clear_stylebox(name: StringName, theme_type: StringName) -> void
  Removes the StyleBox property defined by name and theme_type, if it exists. Fails if it doesn't exist. Use has_stylebox() to check for existence.
...
- default_base_scale: float = 0.0 [set set_default_base_scale; get get_default_base_scale]
...
- default_font: Font [set set_default_font; get get_default_font]
...
- default_font_size: int = -1 [set set_default_font_size; get get_default_font_size]
