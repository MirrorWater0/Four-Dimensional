...
- Name: SpotLight3D
- Source: SpotLight3D.xml
- Inherits: Light3D
- Inheritance Chain: SpotLight3D -> Light3D -> VisualInstance3D -> Node3D -> Node -> Object
...
- shadow_bias: float = 0.03 [set set_param; get get_param; override Light3D]

- shadow_normal_bias: float = 1.0 [set set_param; get get_param; override Light3D]

- spot_angle: float = 45.0 [set set_param; get get_param]
