...
- Source: CopyTransformModifier3D.xml
- Inherits: BoneConstraint3D
- Inheritance Chain: CopyTransformModifier3D -> BoneConstraint3D -> SkeletonModifier3D -> Node3D -> Node -> Object
...
```
[methods]
get_axis_flags(index: int) -> int (CopyTransformModifier3D.AxisFlag) [const]
get_copy_flags(index: int) -> int (CopyTransformModifier3D.TransformFlag) [const]
get_invert_flags(index: int) -> int (CopyTransformModifier3D.AxisFlag) [const]
is_additive(index: int) -> bool [const]
is_axis_x_enabled(index: int) -> bool [const]
is_axis_x_inverted(index: int) -> bool [const]
is_axis_y_enabled(index: int) -> bool [const]
is_axis_y_inverted(index: int) -> bool [const]
is_axis_z_enabled(index: int) -> bool [const]
is_axis_z_inverted(index: int) -> bool [const]
is_position_copying(index: int) -> bool [const]
is_relative(index: int) -> bool [const]
is_rotation_copying(index: int) -> bool [const]
is_scale_copying(index: int) -> bool [const]
set_additive(index: int, enabled: bool) -> void
set_axis_flags(index: int, axis_flags: int (CopyTransformModifier3D.AxisFlag)) -> void
set_axis_x_enabled(index: int, enabled: bool) -> void
set_axis_x_inverted(index: int, enabled: bool) -> void
set_axis_y_enabled(index: int, enabled: bool) -> void
set_axis_y_inverted(index: int, enabled: bool) -> void
set_axis_z_enabled(index: int, enabled: bool) -> void
set_axis_z_inverted(index: int, enabled: bool) -> void
set_copy_flags(index: int, copy_flags: int (CopyTransformModifier3D.TransformFlag)) -> void
set_copy_position(index: int, enabled: bool) -> void
set_copy_rotation(index: int, enabled: bool) -> void
set_copy_scale(index: int, enabled: bool) -> void
set_invert_flags(index: int, axis_flags: int (CopyTransformModifier3D.AxisFlag)) -> void
