...
- Source: GPUParticlesAttractor3D.xml
- Inherits: VisualInstance3D
- Inheritance Chain: GPUParticlesAttractor3D -> VisualInstance3D -> Node3D -> Node -> Object
...
- directionality: float = 0.0 [set set_directionality; get get_directionality]
