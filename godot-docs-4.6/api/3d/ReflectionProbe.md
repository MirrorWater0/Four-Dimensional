...
- Source: ReflectionProbe.xml
- Inherits: VisualInstance3D
- Inheritance Chain: ReflectionProbe -> VisualInstance3D -> Node3D -> Node -> Object
...
- ambient_color: Color = Color(0, 0, 0, 1) [set set_ambient_color; get get_ambient_color]
...
- ambient_color_energy: float = 1.0 [set set_ambient_color_energy; get get_ambient_color_energy]
...
- ambient_mode: int (ReflectionProbe.AmbientMode) = 1 [set set_ambient_mode; get get_ambient_mode]
...
- blend_distance: float = 1.0 [set set_blend_distance; get get_blend_distance]
  Defines the distance in meters over which a probe blends into the scene.

- box_projection: bool = false [set set_enable_box_projection; get is_box_projection_enabled]
...
- enable_shadows: bool = false [set set_enable_shadows; get are_shadows_enabled]
...
- intensity: float = 1.0 [set set_intensity; get get_intensity]
  Defines the reflection intensity. Intensity modulates the strength of the reflection.

- interior: bool = false [set set_as_interior; get is_set_as_interior]
  If true, reflections will ignore sky contribution.

- max_distance: float = 0.0 [set set_max_distance; get get_max_distance]
...
- reflection_mask: int = 1048575 [set set_reflection_mask; get get_reflection_mask]
...
- size: Vector3 = Vector3(20, 20, 20) [set set_size; get get_size]
...
- update_mode: int (ReflectionProbe.UpdateMode) = 0 [set set_update_mode; get get_update_mode]
