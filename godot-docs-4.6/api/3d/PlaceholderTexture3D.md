...
- Source: PlaceholderTexture3D.xml
- Inherits: Texture3D
- Inheritance Chain: PlaceholderTexture3D -> Texture3D -> Texture -> Resource -> RefCounted -> Object
...
- size: Vector3i = Vector3i(1, 1, 1) [set set_size; get get_size]
