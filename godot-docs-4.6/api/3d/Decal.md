...
- Inheritance Chain: Decal -> VisualInstance3D -> Node3D -> Node -> Object
...
```
[methods]
get_texture(type: int (Decal.DecalTexture)) -> Texture2D [const]
set_texture(type: int (Decal.DecalTexture), texture: Texture2D) -> void
...
- albedo_mix: float = 1.0 [set set_albedo_mix; get get_albedo_mix]
...
- emission_energy: float = 1.0 [set set_emission_energy; get get_emission_energy]
...
- lower_fade: float = 0.3 [set set_lower_fade; get get_lower_fade]
...
- normal_fade: float = 0.0 [set set_normal_fade; get get_normal_fade]
...
- texture_albedo: Texture2D [set set_texture; get get_texture]
...
- texture_emission: Texture2D [set set_texture; get get_texture]
...
- texture_normal: Texture2D [set set_texture; get get_texture]
...
- texture_orm: Texture2D [set set_texture; get get_texture]
...
- upper_fade: float = 0.3 [set set_upper_fade; get get_upper_fade]
