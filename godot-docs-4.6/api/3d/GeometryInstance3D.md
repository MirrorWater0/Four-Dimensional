...
- Source: GeometryInstance3D.xml
- Inherits: VisualInstance3D
- Inheritance Chain: GeometryInstance3D -> VisualInstance3D -> Node3D -> Node -> Object
...
- [Visibility ranges (HLOD)]($DOCS_URL/tutorials/3d/visibility_ranges.html)
...
- extra_cull_margin: float = 0.0 [set set_extra_cull_margin; get get_extra_cull_margin]
  The extra distance added to the GeometryInstance3D's bounding box (AABB) to increase its cull box.

- gi_lightmap_scale: int (GeometryInstance3D.LightmapScale) = 0 [set set_lightmap_scale; get get_lightmap_scale]
  The texel density to use for lightmapping in LightmapGI.

- gi_lightmap_texel_scale: float = 1.0 [set set_lightmap_texel_scale; get get_lightmap_texel_scale]
...
- gi_mode: int (GeometryInstance3D.GIMode) = 1 [set set_gi_mode; get get_gi_mode]
...
- ignore_occlusion_culling: bool = false [set set_ignore_occlusion_culling; get is_ignoring_occlusion_culling]
...
- lod_bias: float = 1.0 [set set_lod_bias; get get_lod_bias]
...
- material_overlay: Material [set set_material_overlay; get get_material_overlay]
...
- material_override: Material [set set_material_override; get get_material_override]
...
- transparency: float = 0.0 [set set_transparency; get get_transparency]
