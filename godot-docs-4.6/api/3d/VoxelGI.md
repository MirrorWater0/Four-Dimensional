...
- Inheritance Chain: VoxelGI -> VisualInstance3D -> Node3D -> Node -> Object
...
```
[methods]
bake(from_node: Node = null, create_visual_debug: bool = false) -> void
debug_bake() -> void
...
- data: VoxelGIData [set set_probe_data; get get_probe_data]
  The VoxelGIData resource that holds the data for this VoxelGI.

- size: Vector3 = Vector3(20, 20, 20) [set set_size; get get_size]
  The size of the area covered by the VoxelGI. This must be 1.0 or greater on each axis. **Note:** If you make the size larger without increasing the number of subdivisions with subdiv, the size of each cell will increase and result in less detailed lighting.

- subdiv: int (VoxelGI.Subdiv) = 1 [set set_subdiv; get get_subdiv]
