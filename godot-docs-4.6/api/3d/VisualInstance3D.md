...
- Source: VisualInstance3D.xml
- Inherits: Node3D
- Inheritance Chain: VisualInstance3D -> Node3D -> Node -> Object
...
get_aabb() -> AABB [const]
get_base() -> RID [const]
get_instance() -> RID [const]
get_layer_mask_value(layer_number: int) -> bool [const]
set_base(base: RID) -> void
set_layer_mask_value(layer_number: int, value: bool) -> void
...
- layers: int = 1 [set set_layer_mask; get get_layer_mask]
...
- sorting_offset: float = 0.0 [set set_sorting_offset; get get_sorting_offset]
...
- sorting_use_aabb_center: bool [set set_sorting_use_aabb_center; get is_sorting_use_aabb_center]
