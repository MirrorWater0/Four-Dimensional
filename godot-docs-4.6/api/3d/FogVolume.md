...
- Name: FogVolume
- Source: FogVolume.xml
- Inherits: VisualInstance3D
- Inheritance Chain: FogVolume -> VisualInstance3D -> Node3D -> Node -> Object
...
- [Volumetric fog and fog volumes]($DOCS_URL/tutorials/3d/volumetric_fog.html)
...
- shape: int (RenderingServer.FogVolumeShape) = 3 [set set_shape; get get_shape]
