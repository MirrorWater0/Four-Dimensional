...
- Name: MeshInstance3D
- Source: MeshInstance3D.xml
- Inherits: GeometryInstance3D
- Inheritance Chain: MeshInstance3D -> GeometryInstance3D -> VisualInstance3D -> Node3D -> Node -> Object
...
create_convex_collision(clean: bool = true, simplify: bool = false) -> void
create_debug_tangents() -> void
create_multiple_convex_collisions(settings: MeshConvexDecompositionSettings = null) -> void
create_trimesh_collision() -> void
find_blend_shape_by_name(name: StringName) -> int
get_active_material(surface: int) -> Material [const]
get_blend_shape_count() -> int [const]
get_blend_shape_value(blend_shape_idx: int) -> float [const]
get_skin_reference() -> SkinReference [const]
get_surface_override_material(surface: int) -> Material [const]
get_surface_override_material_count() -> int [const]
...
- skeleton: NodePath = NodePath("") [set set_skeleton_path; get get_skeleton_path]
  NodePath to the Skeleton3D associated with the instance. **Note:** The default value of this property has changed in Godot 4.6. Enable ProjectSettings.animation/compatibility/default_parent_skeleton_in_mesh_instance_3d if the old behavior is needed for compatibility.
