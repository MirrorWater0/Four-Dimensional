...
- Source: GPUParticlesCollisionHeightField3D.xml
- Inherits: GPUParticlesCollision3D
- Inheritance Chain: GPUParticlesCollisionHeightField3D -> GPUParticlesCollision3D -> VisualInstance3D -> Node3D -> Node -> Object
...
```
[methods]
get_heightfield_mask_value(layer_number: int) -> bool [const]
set_heightfield_mask_value(layer_number: int, value: bool) -> void
...
- follow_camera_enabled: bool = false [set set_follow_camera_enabled; get is_follow_camera_enabled]
...
- update_mode: int (GPUParticlesCollisionHeightField3D.UpdateMode) = 0 [set set_update_mode; get get_update_mode]
