...
- Name: VehicleBody3D
- Source: VehicleBody3D.xml
- Inherits: RigidBody3D
- Inheritance Chain: VehicleBody3D -> RigidBody3D -> PhysicsBody3D -> CollisionObject3D -> Node3D -> Node -> Object
...
- mass: float = 40.0 [set set_mass; get get_mass; override RigidBody3D]
