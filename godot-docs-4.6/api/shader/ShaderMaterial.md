...
- Name: ShaderMaterial
- Source: ShaderMaterial.xml
- Inherits: Material
- Inheritance Chain: ShaderMaterial -> Material -> Resource -> RefCounted -> Object
...
```
[methods]
get_shader_parameter(param: StringName) -> Variant [const]
set_shader_parameter(param: StringName, value: Variant) -> void
...
- shader: Shader [set set_shader; get get_shader]
