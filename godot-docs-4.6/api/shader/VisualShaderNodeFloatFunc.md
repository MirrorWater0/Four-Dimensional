...
- Source: VisualShaderNodeFloatFunc.xml
- Inherits: VisualShaderNode
- Inheritance Chain: VisualShaderNodeFloatFunc -> VisualShaderNode -> Resource -> RefCounted -> Object
...
- function: int (VisualShaderNodeFloatFunc.Function) = 13 [set set_function; get get_function]
