...
- Name: AcceptDialog
- Source: AcceptDialog.xml
- Inherits: Window
- Inheritance Chain: AcceptDialog -> Window -> Viewport -> Node -> Object
...
- dialog_autowrap: bool = false [set set_autowrap; get has_autowrap]
  Sets autowrapping for the text in the dialog.

- dialog_close_on_escape: bool = true [set set_close_on_escape; get get_close_on_escape]
...
- dialog_hide_on_ok: bool = true [set set_hide_on_ok; get get_hide_on_ok]
...
- dialog_text: String = "" [set set_text; get get_text]
  The text displayed by the dialog.

- exclusive: bool = true [set set_exclusive; get is_exclusive; override Window]

- keep_title_visible: bool = true [set set_keep_title_visible; get get_keep_title_visible; override Window]
...
- ok_button_text: String = "" [set set_ok_button_text; get get_ok_button_text]
  The text displayed by the OK button (see get_ok_button()). If empty, a default text will be used.

- title: String = "Alert!" [set set_title; get get_title; override Window]
