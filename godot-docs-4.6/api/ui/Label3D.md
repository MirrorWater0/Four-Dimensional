...
- Inheritance Chain: Label3D -> GeometryInstance3D -> VisualInstance3D -> Node3D -> Node -> Object
...
get_draw_flag(flag: int (Label3D.DrawFlags)) -> bool [const]
set_draw_flag(flag: int (Label3D.DrawFlags), enabled: bool) -> void
...
- alpha_cut: int (Label3D.AlphaCutMode) = 0 [set set_alpha_cut_mode; get get_alpha_cut_mode]
...
- cast_shadow: int (GeometryInstance3D.ShadowCastingSetting) = 0 [set set_cast_shadows_setting; get get_cast_shadows_setting; override GeometryInstance3D]
...
- font_size: int = 32 [set set_font_size; get get_font_size]
...
- gi_mode: int (GeometryInstance3D.GIMode) = 0 [set set_gi_mode; get get_gi_mode; override GeometryInstance3D]

- horizontal_alignment: int (HorizontalAlignment) = 1 [set set_horizontal_alignment; get get_horizontal_alignment]
...
- outline_modulate: Color = Color(0, 0, 0, 1) [set set_outline_modulate; get get_outline_modulate]
  The tint of text outline.

- outline_render_priority: int = -1 [set set_outline_render_priority; get get_outline_render_priority]
...
- outline_size: int = 12 [set set_outline_size; get get_outline_size]
  Text outline size.

- pixel_size: float = 0.005 [set set_pixel_size; get get_pixel_size]
...
- text_direction: int (TextServer.Direction) = 0 [set set_text_direction; get get_text_direction]
...
- vertical_alignment: int (VerticalAlignment) = 1 [set set_vertical_alignment; get get_vertical_alignment]
  Controls the text's vertical alignment. Supports top, center, and bottom.

- width: float = 500.0 [set set_width; get get_width]
