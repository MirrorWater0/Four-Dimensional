...
- Name: XRFaceTracker
- Source: XRFaceTracker.xml
- Inherits: XRTracker
- Inheritance Chain: XRFaceTracker -> XRTracker -> RefCounted -> Object
...
```
[methods]
get_blend_shape(blend_shape: int (XRFaceTracker.BlendShapeEntry)) -> float [const]
set_blend_shape(blend_shape: int (XRFaceTracker.BlendShapeEntry), weight: float) -> void
...
- blend_shapes: PackedFloat32Array = PackedFloat32Array() [set set_blend_shapes; get get_blend_shapes]
  The array of face blend shape weights with indices corresponding to the BlendShapeEntry enum.

- type: int (XRServer.TrackerType) = 64 [set set_tracker_type; get get_tracker_type; override XRTracker]
