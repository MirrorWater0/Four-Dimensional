...
- Source: XRPositionalTracker.xml
- Inherits: XRTracker
- Inheritance Chain: XRPositionalTracker -> XRTracker -> RefCounted -> Object
...
set_input(name: StringName, value: Variant) -> void
set_pose(name: StringName, transform: Transform3D, linear_velocity: Vector3, angular_velocity: Vector3, tracking_confidence: int (XRPose.TrackingConfidence)) -> void
...
- hand: int (XRPositionalTracker.TrackerHand) = 0 [set set_tracker_hand; get get_tracker_hand]
  Defines which hand this tracker relates to.

- profile: String = "" [set set_tracker_profile; get get_tracker_profile]
