...
- Source: JSONRPC.xml
- Inherits: Object
- Inheritance Chain: JSONRPC -> Object
...
make_response_error(code: int, message: String, id: Variant = null) -> Dictionary [const]
...
- set_method(name: String, callback: Callable) -> void
  Registers a callback for the given method name. - name: The name that clients can use to access the callback. - callback: The callback which will handle the specified method.
