...
- Name: PhysicsBody3D
- Source: PhysicsBody3D.xml
- Inherits: CollisionObject3D
- Inheritance Chain: PhysicsBody3D -> CollisionObject3D -> Node3D -> Node -> Object
...
get_axis_lock(axis: int (PhysicsServer3D.BodyAxis)) -> bool [const]
...
set_axis_lock(axis: int (PhysicsServer3D.BodyAxis), lock: bool) -> void
