...
- Name: ShapeCast2D
- Source: ShapeCast2D.xml
- Inherits: Node2D
- Inheritance Chain: ShapeCast2D -> Node2D -> CanvasItem -> Node -> Object
...
get_collision_normal(index: int) -> Vector2 [const]
get_collision_point(index: int) -> Vector2 [const]
