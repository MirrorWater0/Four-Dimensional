...
- Source: CharacterBody3D.xml
- Inherits: PhysicsBody3D
- Inheritance Chain: CharacterBody3D -> PhysicsBody3D -> CollisionObject3D -> Node3D -> Node -> Object
...
get_floor_angle(up_direction: Vector3 = Vector3(0, 1, 0)) -> float [const]
get_floor_normal() -> Vector3 [const]
get_last_motion() -> Vector3 [const]
get_last_slide_collision() -> KinematicCollision3D
get_platform_angular_velocity() -> Vector3 [const]
get_platform_velocity() -> Vector3 [const]
get_position_delta() -> Vector3 [const]
get_real_velocity() -> Vector3 [const]
get_slide_collision(slide_idx: int) -> KinematicCollision3D
get_slide_collision_count() -> int [const]
get_wall_normal() -> Vector3 [const]
...
- floor_snap_length: float = 0.1 [set set_floor_snap_length; get get_floor_snap_length]
...
- max_slides: int = 6 [set set_max_slides; get get_max_slides]
...
- motion_mode: int (CharacterBody3D.MotionMode) = 0 [set set_motion_mode; get get_motion_mode]
...
- platform_on_leave: int (CharacterBody3D.PlatformOnLeave) = 0 [set set_platform_on_leave; get get_platform_on_leave]
...
- safe_margin: float = 0.001 [set set_safe_margin; get get_safe_margin]
...
- up_direction: Vector3 = Vector3(0, 1, 0) [set set_up_direction; get get_up_direction]
...
- velocity: Vector3 = Vector3(0, 0, 0) [set set_velocity; get get_velocity]
  Current velocity vector (typically meters per second), used and modified during calls to move_and_slide(). **Note:** A common mistake is setting this property to the desired velocity multiplied by delta, which produces a motion vector (typically in meters).
