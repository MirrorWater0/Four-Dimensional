...
- Name: HingeJoint3D
- Source: HingeJoint3D.xml
- Inherits: Joint3D
- Inheritance Chain: HingeJoint3D -> Joint3D -> Node3D -> Node -> Object
...
```
[methods]
get_flag(flag: int (HingeJoint3D.Flag)) -> bool [const]
get_param(param: int (HingeJoint3D.Param)) -> float [const]
set_flag(flag: int (HingeJoint3D.Flag), enabled: bool) -> void
set_param(param: int (HingeJoint3D.Param), value: float) -> void
...
- angular_limit/bias: float = 0.3 [set set_param; get get_param]
  The speed with which the rotation across the axis perpendicular to the hinge gets corrected.

- angular_limit/enable: bool = false [set set_flag; get get_flag]
  If true, the hinges maximum and minimum rotation, defined by angular_limit/lower and angular_limit/upper has effects.

- angular_limit/lower: float = -1.5707964 [set set_param; get get_param]
  The minimum rotation. Only active if angular_limit/enable is true.

- angular_limit/relaxation: float = 1.0 [set set_param; get get_param]
  The lower this value, the more the rotation gets slowed down.

- angular_limit/softness: float = 0.9 [set set_param; get get_param]

- angular_limit/upper: float = 1.5707964 [set set_param; get get_param]
  The maximum rotation. Only active if angular_limit/enable is true.

- motor/enable: bool = false [set set_flag; get get_flag]
  When activated, a motor turns the hinge.

- motor/max_impulse: float = 1.0 [set set_param; get get_param]
  Maximum acceleration for the motor.

- motor/target_velocity: float = 1.0 [set set_param; get get_param]
