...
- Source: PhysicsRayQueryParameters2D.xml
- Inherits: RefCounted
- Inheritance Chain: PhysicsRayQueryParameters2D -> RefCounted -> Object
...
```
[methods]
create(from: Vector2, to: Vector2, collision_mask: int = 4294967295, exclude: RID[] = []) -> PhysicsRayQueryParameters2D [static]
...
- from: Vector2 = Vector2(0, 0) [set set_from; get get_from]
...
- to: Vector2 = Vector2(0, 0) [set set_to; get get_to]
