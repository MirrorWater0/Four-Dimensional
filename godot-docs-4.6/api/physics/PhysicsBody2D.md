...
- Name: PhysicsBody2D
- Source: PhysicsBody2D.xml
- Inherits: CollisionObject2D
- Inheritance Chain: PhysicsBody2D -> CollisionObject2D -> Node2D -> CanvasItem -> Node -> Object
...
- input_pickable: bool = false [set set_pickable; get is_pickable; override CollisionObject2D]
